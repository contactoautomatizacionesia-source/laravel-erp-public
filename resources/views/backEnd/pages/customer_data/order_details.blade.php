...
@section('mainContent')
    <div id="add_product">
        <section class="admin-visitor-area up_st_admin_visitor ign-my-purchase-order-details">
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="white_box_30px box_shadow_white" id="printableArea">
                                                    ...
                                                    <table class="table products-table">
                                                        ...
                                                        @foreach ($order_package->products as $key => $package_product)
                                                            <tr>
                                                                ...
                                                                <td class="text-nowrap">{{ $package_product->unit_club_point }}</td>
                            ...
                            <div class="row mt-30">
                                @if (@$order->order_payment->payment_method == 7)
                                    <div class="col-md-6 col-lg-6">
                                        <h4 class="table-heading">{{__('order.bank_details')}}</h4>
                                        <table class="invoice-table table-borderless clone_line_table">
                                ...
                                <div class="col-md-6 col-lg-6 ml-auto">
                                    <div class="border rounded-lg shadow-sm p-3">
                                        ...
                                        <table class="totals-table table-borderless clone_line_table w-100">
                                            ...
                                            <tr>
                                                ...
                                                <td class="pl-25 text-nowrap"> {{ $order->total_points }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 student-details">
                        ...
                        <div class="dashboard_white_box style3 rounded-0 bg-white mb_20">
                            ...
                            <p class="lineHeight1 font_14 f_w_400 mb-0 process-description">{{ $process->description }}</p>
                            </div>
                        </div>
                        @endforeach
                        <hr>

        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <div class="box_header_right">
                    <div class="float-lg-right float-none pos_tab_btn justify-content-end align-items-center d-flex flex-wrap gap-2">
                        @if(isModuleActive('DigitalFolder'))
                            <a href="{{ route('admin.file-explorer.index') }}" class="primary-btn small fix-gr-bg mr-2">
                                <span class="ti-folder mr-1"></span>{{ __('common.user_folder') }}
                            </a>
                        @endif
                        <ul class="nav">
                            <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active show" id="basicInfo">
                            ...
                            <form action="#" name="basic_info" method="POST" id="basic_info"
                                ...
                                @csrf
                                <input type="hidden" name="validate_block" value="admin_update">
                                <div class="row">
                                    <div class="col-xl-6">
                                                    ...
                                                    <div class="col">
                                                        <div class="">
                                                            <input placeholder="{{ __('common.date') }}"
                                                                ...
                                                                value="{{ dateConvert($user_info->date_of_birth) }}"
                                                                autocomplete="off">
                                    ...
                                    <div class="col-lg-3">
                                        <div id="avatar_preview_div">
                                            <img id="avatar_preview"
                                                src="{{showImage($user_info->avatar != null?$user_info->avatar:'backend/img/avatar.png')}}"
                                                alt="">
                                        </div>
                                    </div>

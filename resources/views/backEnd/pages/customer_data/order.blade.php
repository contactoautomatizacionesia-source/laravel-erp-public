                ...
                <div class="box_header_right">
                    <div class="float-lg-right float-none pos_tab_btn justify-content-end">
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#toPayData" role="tab" data-toggle="tab" aria-selected="false">{{ __('customer_panel.to_pay') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#toShipData" role="tab" data-toggle="tab" aria-selected="false">{{ __('customer_panel.to_ship') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#toRecieveData" role="tab" data-toggle="tab" aria-selected="false">{{ __('customer_panel.to_recieve') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                @foreach ($orders as $key => $order)
                                    <div class="single_order_part">
                                        <div class="order_details_status">
                                            ...
                                            <a target="_blank" href="{{ route('frontend.my_purchase_order_pdf', encrypt($order->id)) }}" class="primary-btn radius_30px mr-10 fix-gr-bg text-white">{{__('defaultTheme.download_invoice')}} &nbsp;&nbsp;&nbsp;&nbsp; </a>
                                        </div>

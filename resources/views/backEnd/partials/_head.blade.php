<head>
    ...
    <title id="header_title">@hasSection('page-title'){{ app('general_setting')->site_title }} | @yield('page-title')@else{{ app('general_setting')->site_title }} | {{ $path }}@endif</title>
    ...
    <!-- uppy css -->
    {{-- Archivo movido a el componenete que lo necesita para no cargarlo siempre --}}
    ...
    <link rel="stylesheet" href="{{ asset(asset_path('css/tailwind.css')) }}" />

...
@if($general_setting->preloader_status)
    @if($general_setting->preloader_type == 2)
        <div class="preloader" dir="ltr" >
            <img style="width: 200px" src="{{showImage($general_setting->preloader_image?$general_setting->preloader_image:$general_setting->favicon)}}" alt="">
        </div>
    @else
        @if(!$general_setting->preloader_style || $general_setting->preloader_style == 0)
        ...
        @elseif($general_setting->preloader_style==1)
            <div class="preloader" dir="ltr">
                <div class="circle circle1"></div>
            </div>
        @elseif($general_setting->preloader_style==2)
            <div class="preloader" dir="ltr">
                <div class="circle circle2"></div>
            </div>
        @elseif($general_setting->preloader_style==3)
            <div class="preloader" dir="ltr">
                <div class="circle circle3 c31"></div>
                <div class="circle circle3 c32"></div>
            </div>
        @elseif($general_setting->preloader_style==4)
            <div class="preloader" dir="ltr">
        ...
        @elseif($general_setting->preloader_style==5)
            <div class="preloader" dir="ltr">
                <div class="circle circle5 c51"></div>
            </div>
        @elseif($general_setting->preloader_style==6)
            <div class="preloader" dir="ltr">
        ...
        @elseif($general_setting->preloader_style==7)
            <div class="preloader" dir="ltr">
        ...
        @elseif($general_setting->preloader_style==8)
            <div class="preloader" dir="ltr">
        ...
        @elseif($general_setting->preloader_style==9)
            <div class="preloader" dir="ltr">
        ...
        @elseif($general_setting->preloader_style==10)
            <div class="preloader" dir="ltr">
        ...
        @elseif($general_setting->preloader_style==11)
        ...
        @elseif($general_setting->preloader_style==12)
        ...
        @elseif($general_setting->preloader_style==13)

            <div class="preloader" dir="ltr">
                <div class="circle circle13 c131"></div>
            </div>
        @elseif($general_setting->preloader_style==14)

            <div class="preloader" dir="ltr">
                <div class="circle circle14 c141"></div>
            </div>
        @elseif($general_setting->preloader_style==15)

            <div class="preloader" dir="ltr">
                <div class="circle circle15 c151"></div>
            </div>
        @elseif($general_setting->preloader_style==16)
        ...
        @elseif($general_setting->preloader_style==17)
        ...
        @elseif($general_setting->preloader_style==18)

            <div class="preloader" dir="ltr">
                <div class="dot dot3"></div>
                <div class="dot dot3 dot31"></div>
            </div>
        @elseif($general_setting->preloader_style==19)

            <div class="preloader" dir="ltr">
                <div class="dot dot4"></div>
                <div class="dot dot4 dot41"></div>
            </div>
        @elseif($general_setting->preloader_style==20)
        ...
        @elseif($general_setting->preloader_style==21)
        ...
        @elseif($general_setting->preloader_style==22)
        ...
        @elseif($general_setting->preloader_style==23)
        ...
        @elseif($general_setting->preloader_style==24)
        ...
        @elseif($general_setting->preloader_style == 25)
            <div class="lifehuni-preloader-wrapper">
        ...
        @elseif($general_setting->preloader_style == 26)
        <div class="lifehuni-pulse-wrapper">
        ...
        @elseif($general_setting->preloader_style == 27)
            <div class="lifehuni-flow-wrapper">
            ...
            <div class="lifehuni-flow-center">
                <img src="{{ showImage($general_setting->favicon) }}" alt="{{ app('general_setting')->site_title }}" width="44">
            </div>

...
<section class="admin-visitor-area up_st_admin_visitor ign-create-staff">
            ...
            <div class="col-12">
                <div class="white_box_30px box_shadow_white">
                    <form action="{{ route('staffs.store') }}" method="POST" id="staff_addForm"
                        ...
                        @csrf
                        <div class="form-card">
                            <h3 class="">{{ __('common.basic_info') }}</h3>
                            <div class="row">
                                <div class="col-xl-4">
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="">{{ __('common.document_type') }} <span
                                                class="text-danger">*</span></label>
                                        <select class="primary_select mb-25" name="document_type" id="document_type"
                                            required>
                                            @foreach ($typeDocuments as $key => $doc_type)
                                            <option value="{{ $doc_type->id }}" @if(old('document_type') &&
                                                old('document_type')==$doc_type->id) selected
                                                @endif>{{ $doc_type->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input name="document_number" class="primary_input_field name"
                                            placeholder="{{ __('common.document_number') }}" type="text"
                                    ...
                                    <div class="primary_input mb-25">
                                        ...
                                        <select class="primary_select mb-25" name="cost_center_id" id="cost_center_id">
                                            ...
                                            @foreach ($cost_centers as $cost_center)
                                                ...
                                                @endphp
                                                <option value="{{ $cost_center->id }}" {{ old('cost_center_id') == $cost_center->id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>

            ...
            <div class="col-12">
                <div class="white_box_30px box_shadow_white">
                    <form action="{{ route('staffs.update', $staff->user->id) }}" method="POST"
                        ...
                        <div class="form-card">
                            <h3 class="mb-2">{{ __('common.basic_info') }}</h3>
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="">{{ __('common.document_type') }} <span
                                                class="text-danger">*</span></label>
                                        <select class="primary_select mb-25" name="document_type" id="document_type" required>
                                            @foreach ($typeDocuments as $key => $document_type)
                                            <option value="{{ $document_type->id }}" @if ($document_type->id ==
                                                $staff->type_document_id) selected @endif>{{ $document_type->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="">{{ __('common.document_number') }}</label>
                                        <input name="document_number" class="primary_input_field name"
                                            placeholder="{{ __('common.document_number') }}"
                                            value="{{ old('document_number')?old('document_number'):@$staff->document_number }}" type="text">
                        ...
                        <div class="form-card">
                            <h3 class="mb-2">{{ __('hr.cost_center') }}</h3>
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="cost_center_id">{{ __('hr.cost_center') }}</label>
                                        <select class="primary_select mb-25" name="cost_center_id" id="cost_center_id">
                                            ...
                                            @foreach ($cost_centers as $cost_center)
                                                @php
                                                    $label = implode(' - ', array_filter([
                                                        $cost_center->code,
                                                        $cost_center->name,
                                                        optional($cost_center->city)->name,
                                                        optional($cost_center->brand)->name,
                                                    ]));
                                                @endphp
                                                <option value="{{ $cost_center->id }}" {{ (old('cost_center_id') ?? $staff->user->cost_center_id) == $cost_center->id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                        <span class="text-danger">{{$errors->first('cost_center_id')}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-card">
                            <h3 class="mb-2">{{ __('hr.bank_info') }}</h3>
                            <div class="row">

...
@endpush
@section('content')
<div class="bg-custom-login row ign-register py-5 ">
    <div class="col-8 mx-auto">
        <div class="amazy_login_form">
            <a href="{{url('/')}}" class="logo mb_50 d-block text-center">
                <img src="{{showImage(app('general_setting')->logo)}}" alt="{{app('general_setting')->company_name}}" title="{{app('general_setting')->company_name}}">
            </a>
            <h3 class="m-0 text-center">{{__('auth.Sign Up')}}</h3>
            <p class="support_text text-center">{{__('auth.See your growth and get consulting support!')}}</p>
            ...
            <form action="{{ route('register') }}" method="POST" name="register" id="register_form" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    @else
                        ...
                        @endif
                        <div class="col-12 mb_20">
                            <label for="referral_code" class="primary_label2">{{__('formBuilder.referral_code_(optional)')}}</label>
                            <input name="referral_code" id="referral_code" value="{{ old('referral_code') }}" placeholder="{{ __('formBuilder.referral_code') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{ __('common.referral_code') }}'" class="primary_input3 radius_5px" type="text">

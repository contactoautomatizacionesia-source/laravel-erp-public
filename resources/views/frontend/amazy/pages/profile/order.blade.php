...
@section('profile_content')
    <div class="col-xl-12 col-lg-8">
        <div class="order_tab_box d-flex justify-content-between gap-2 flex-wrap mb_20">
            <ul class="nav amazy_order_tabs d-inline-flex" id="myTab" >
                <li class="nav-item">
                    ...
                    @foreach ($orders as $key => $order)
                        <div class="white_box style2 bg-white mb_20">
                            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                ...
                                <div class="d-flex flex-column  ">
                                    <a class="amaz_primary_btn gray_bg_btn min_200 radius_3px" target="_blank" href="{{ route('frontend.my_purchase_order_pdf', encrypt($order->id)) }}">{{__('defaultTheme.download_invoice')}}</a>
                                </div>
                            </div>
                            <div class="dashboard_white_box_body">
                                                ...
                                                @foreach ($package->products as $key => $package_product)
                                                    @if ($package_product->type == "gift_card")
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h4 class="font_16_top f_w_500 m-0 text-nowrap">{{__('common.qty') }}: {{ getNumberTranslate($package_product->qty) }}</h4>
                                                            </td>
                                                            <td>
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td>
                                                                <a href="{{singleProductURL(@$package_product->seller_product_sku->product->seller->slug, @$package_product->seller_product_sku->product->slug)}}" class="d-flex align-items-center gap_20 cart_thumb_div">
                                                                    <div class="thumb">
                                                                        ...
                                                                        @endphp
                                                                            <img src="{{showImage($image)}}" alt="@if (@$package_product->seller_product_sku->product->product_name) {{textLimit(@$package_product->seller_product_sku->product->product_name,22)}} @else {{textLimit(@$package_product->seller_product_sku->sku->product->product_name,22)}} @endif" title="@if (@$package_product->seller_product_sku->product->product_name) {{textLimit(@$package_product->seller_product_sku->product->product_name,22)}} @else {{textLimit(@$package_product->seller_product_sku->sku->product->product_name,22)}} @endif">
                                                                        @else
                                                                        @php
                                                            ...
                                                            <td>
                                                                <h4 class="font_16_top f_w_500 m-0 text-nowrap">{{__('common.points') }}: {{ getNumberTranslate($package_product->unit_club_point) }}</h4>
                                                            </td>
                                                            <td>
                                                                <h4 class="font_16 f_w_500 m-0 text-nowrap">{{ single_price($package_product->price) }}</h4>
                                                            </td>
                                ...
                                <div class="d-flex justify-content-end flex-wrap gap_10">
                                    <a href="{{ route('frontend.my_purchase_order_detail', encrypt($order->id)) }}" class="btn-toolkit btn-primary">{{__('defaultTheme.order_details')}}</a>
                                    <a href="{{ route('frontend.my_purchase_order_detail', encrypt($order->id)) }}#differentials" class="btn-toolkit btn-secondary">{{ __('tree.differentials_distribution') }}</a>
                                    @if ($order->is_confirmed == 0)
                                        @if ($order->is_cancelled == 0)
                                            <a data-id={{ $order->id }} class="btn-toolkit btn-danger order_cancel_by_id" href="">{{__('defaultTheme.cancel_order')}}</a>
                    ...
                    @foreach ($no_paid_orders as $key => $no_paid_order)
                        ...
                        <div class="white_box style2 bg-white mb_20">
                            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        ...
                                        @php
                                            if ($no_paid_order->is_cancelled == 1) {
                                                ...
                                                $orderStatusText = __('common.completed');
                                                $orderStatusClass = 'badge_1';
                                            } elseif ($no_paid_order->is_confirmed == 1) {
                                                $orderStatusText = __('common.confirmed');
                                                $orderStatusClass = 'badge_1';
                                        ...
                                        @endphp
                                        <p class="font_14 f_w_400 m-0 lh-base {{ $orderStatusClass }}">
                                            {{ $orderStatusText }}
                                        </p>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                ...
                                <div class="d-flex flex-column  ">
                                    <a target="_blank" href="{{ route('frontend.my_purchase_order_pdf', encrypt($no_paid_order->id)) }}" class="amaz_primary_btn gray_bg_btn min_200 radius_3px">+ {{__('defaultTheme.download_invoice')}}</a>
                                </div>
                            </div>
                            <div class="dashboard_white_box_body">
                                <div class="table-responsive mb_10">
                                                ...
                                                @foreach ($package->products as $key => $package_product)
                                                    @if ($package_product->type == "gift_card")
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h4 class="font_16_top f_w_500 m-0 ">{{__('common.qty')}}: {{ getNumberTranslate($package_product->qty) }}</h4>
                                                            </td>
                                                            <td>
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('frontend.my_purchase_order_detail', encrypt($no_paid_order->id)) }}" class="btn-toolkit btn-primary">{{__('defaultTheme.order_details')}}</a>
                                </div>
                            </div>
                        </div>
                        <!-- content ::end    -->
                    ...
                    @foreach ($to_shippeds as $key => $order_package)
                        ...
                        <div class="white_box style2 bg-white mb_20">
                            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                                ...
                                <div class="d-flex flex-column  ">
                                    <a target="_blank" href="{{ route('frontend.my_purchase_order_pdf', encrypt(@$order_package->order->id)) }}" class="amaz_primary_btn gray_bg_btn min_200 radius_3px">+ {{__('defaultTheme.download_invoice')}}</a>
                                </div>
                            </div>
                            <div class="dashboard_white_box_body">
                                <div class="table-responsive mb_10">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('frontend.my_purchase_order_detail', encrypt($order_package->order->id)) }}" class="btn-toolkit btn-primary">{{__('defaultTheme.order_details') }}</a>
                                </div>
                            </div>
                        </div>
                        <!-- content ::end    -->
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb_30">
                                        <div class="form-group input_div_mb">
                                            <label class="primary_input_label mb-2" for="reason">{{ __('refund.reason') }} *</label>

...
<div class="modal fade theme_modal2" id="purchase_history_modal" tabindex="-1"  aria-labelledby="theme_modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="summery_modal_body">
                    <div class="summery_modal_header d-flex align-items-center gap-2 flex-wrap">
                        <h5 class="font_16 f_w_700 m-0 flex-fill">{{__('order.order_code')}} : {{getNumberTranslate($package->order->order_number)}}</h5>
                        @if(isModuleActive('MultiVendor'))
                            <h5 class="font_16 f_w_700 m-0 flex-fill">{{__('common.package_code')}} : {{getNumberTranslate($package->order->order_number)}}</h5>
                        @endif
                    ...
                    <div class="summery_modal_body_inner ">
                        ...
                        <div class="summery_order_box">
                            ...
                            <div class="summery_order_body d-flex flex-wrap">
                                <div class="summery_lists flex-fill">
                                    ...
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.name')}}</h5>
                                        </div>
                                        <p class="font_14 f_w_400 m-0">{{@$package->order->address->shipping_name}}</p>
                                    </div>
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.email')}}</h5>
                                        </div>
                                        <p class="font_14 f_w_400 m-0">{{@$package->order->address->shipping_email}}</p>
                                    </div>
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.phone_number')}} </h5>
                                        </div>
                                        <p class="font_14 f_w_400 m-0">{{getNumberTranslate(@$package->order->address->shipping_phone)}}</p>
                                    </div>
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.address')}}</h5>
                                        </div>
                                        <p class="font_14 f_w_400 m-0">{{@$package->order->address->shipping_address}}</p>
                                    </div>
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.city')}}</h5>
                                        </div>
                                        <p class="font_14 f_w_400 m-0">{{@$package->order->address->getShippingCity->name}}</p>
                                    </div>
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.state')}}</h5>
                                        </div>
                                        <p class="font_14 f_w_400 m-0">{{@$package->order->address->getShippingState->name}}</p>
                                    </div>
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.country')}}</h5>
                                        </div>
                                ...
                                <div class="summery_lists flex-fill">
                                    ...
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        ...
                                        <p class="font_14 f_w_400 m-0">{{getNumberTranslate(@$package->order->address->billing_phone)}}</p>
                                    </div>
                                    <div class="single_summery_list d-flex align-items-start gap_20">
                                        <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.address')}}</h5>
                                        </div>
                            ...
                            @php
                                $package_total_points = (float) $package->products->sum('total_club_point');
                            @endphp
                                    ...
                                    <table class="table amazy_table3 mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="font_14 f_w_700 border-start-0 border-end-0" scope="col">{{__('common.points')}}</th>
                                            ...
                                            @foreach($package->products as $package_product)
                                                @if ($package_product->type == "gift_card")
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h4 class="font_16 f_w_500 m-0 text-nowrap"> - </h4>
                                                        </td>
                                                        <td>
                                                ...
                                                @else
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h4 class="font_16 f_w_500 m-0 text-nowrap">{{ ($package_product->total_club_point ?? 0) > 0 ? getNumberTranslate($package_product->total_club_point) : '' }}</h4>
                                                        </td>
                                                        <td>
                                                            <h4 class="font_16 f_w_500 m-0 text-nowrap">{{ single_price($package_product->price) }}</h4>
                                                        </td>
                                                        <td>
                                                            <h4 class="font_16 f_w_500 m-0 text-nowrap">{{ getNumberTranslate($package_product->qty) }}</h4>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap_10">
                                                                <h5 class="font_16 f_w_500 m-0 text-nowrap">{{ single_price($package_product->price * $package_product->qty ) }}</h5>
                            ...
                            <div class="subtotal_and_payment_information d-flex flex-wrap gap-3">
                                <div class="thumb flex-fill">
                                     <div class="summery_lists flex-fill">
                                        <h5 class="font_14 f_w_600 m-0 pb_10">{{__('defaultTheme.payment_info')}} @if($package->order->delivery_type == 'pickup_location')({{__('shipping.collect_from_pickup_location')}}) @endif</h5>
                                        <div class="single_summery_list d-flex align-items-start gap_20">
                                            <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.payment_method')}}</h5>
                                            </div>
                                            <p class="font_14 f_w_400 m-0">
                                                @if($package->order->order_payment->payment_method == 1)
                                                {{$package->order->order_payment->GatewayName}}
                                                @else
                                                {{gateway_name($package->order->order_payment->GatewayName)}}
                                                @endif
                                            </p>
                                        </div>
                                        <div class="single_summery_list d-flex align-items-start gap_20">
                                            <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0">{{__('common.payment_reference')}}</h5>
                                            </div>
                                ...
                                <div class="total_sumery_amount">
                                    ...
                                    <div class="single_amount pb-1 d-flex align-items-center justify-content-between">
                                        <h5 class="font_16 f_w_700 m-0">{{__('common.totals_points')}}</h5>
                                        <p class="font_14 f_w_500 m-0">{{ $package_total_points > 0 ? getNumberTranslate($package_total_points) : '' }}</p>
                                    </div>
                                    <div class="single_amount pb-1 d-flex align-items-center justify-content-between">

...
@section('profile_content')
    <div class="dashboard_white_box_header d-flex align-items-center gap_20  mb_20">
        <h3 class="font_20 f_w_700 mb-0 ">{{__('amazy.Digital Products Purchase History')}}</h3>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="amazy_status_btns d-flex gap_5 align-items-center">
                                        <a href="{{ route('digital_file_download', encrypt($digital_product->id)) }}" download="" class="amazy_status_btn">

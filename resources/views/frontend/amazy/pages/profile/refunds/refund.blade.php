        ...
        <div class="white_box roundted rounded-3 style2 bg-white mb_20">
            <div class="white_box_header d-flex align-items-center gap_20 flex-wrap  amazy_bb3 justify-content-between ">
                ...
                <div class="d-flex flex-column ">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap_5">
                        <h4 class="font_14 f_w_500 m-0 lh-base">{{__('defaultTheme.request_sent_date')}}: </h4> <p class="font_14 f_w_400 m-0 lh-base"> {{ getNumberTranslate($my_refund_item->created_at) }}</p>
                    </div>
                </div>
                <div class="d-flex flex-column  ">
                    <div class="d-flex align-items-center flex-wrap gap_5">
                            ...
                            @foreach ($my_refund_item->refund_details as $key => $refund_detail)
                                @foreach ($refund_detail->refund_products as $key => $refund_product)
                                    <tr>
                                        ...
                                        <td>
                                            <h4 class="font_16 f_w_500 m-0 text-nowrap">{{__('common.qty')}}: {{ getNumberTranslate($refund_product->return_qty) }}</h4>
                                        </td>
                                        <td>

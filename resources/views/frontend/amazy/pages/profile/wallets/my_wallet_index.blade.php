                                    ...
                                    <td>
                                        <span class="font_14 f_w_500 mute_text">
                                            ...
                                            switch ($transaction->type) {
                                                case 'Deposite': echo __("wallet.deposite"); break;
                                                case 'Cart Payment': echo __("wallet.cart_payment"); break;
                                                case 'Refund Back': echo __("wallet.refund_back"); break;
                                                case 'Refund': echo __("wallet.refund"); break;
                                                case 'Withdraw': echo __("wallet.withdraw"); break;
                                                case 'point': echo __("clubpoint.point"); break;
                                                default: echo $transaction->type; break;
                                            }
                                            @endphp
                                        </span>
                                    </td>

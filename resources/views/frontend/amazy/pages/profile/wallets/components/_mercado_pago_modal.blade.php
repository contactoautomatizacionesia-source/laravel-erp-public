        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <section class="send_query bg-white contact_form">
                    <script src="https://sdk.mercadopago.com/js/v2" crossorigin="anonymous"></script>
                    @php
                        $credential = getPaymentInfoViaSellerId(1, 'mercadopago');
                    ...
                    <form id="form-checkout">
                        <div class="row">
                            <div class="col-xl-6 col-md-6 mb_20">
                                ...
                                <input required  class="primary_input4 form-control" type="text"  name="cardNumber" id="form-checkout__cardNumber" />
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6 mb_20">
                                ...
                                <input required  class="primary_input4 form-control" type="text"  name="cardExpirationDate" id="form-checkout__cardExpirationDate" />
                            </div>

                            <div class="col-xl-6 col-md-6 mb_20">
                                <label for="form-checkout__cardholderName" class="mb-2">{{ __('payment_gatways.cardholder_name') }}  <span class="text-danger">*</span> </label>
                                <input required class="primary_input4 form-control" type="text"  name="cardholderName" id="form-checkout__cardholderName"/>
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6 mb_20">
                                ...
                                <input required  class="primary_input4 form-control" type="email"  name="cardholderEmail" id="form-checkout__cardholderEmail"/>
                            </div>
                            <div class="col-xl-6 col-md-6 mb_20">
                                <label  for="form-checkout__securityCode" class="mb-2">{{ __('payment_gatways.security_code') }}  <span class="text-danger">*</span> </label>
                                <input required  class="primary_input4 form-control" type="text"  name="securityCode" id="form-checkout__securityCode" />
                            </div>

                            <div class="col-xl-6 col-md-6 mb_20">
                                <label for="form-checkout__issuer" class="mb-2">{{ __('payment_gatways.issuer') }}  <span class="text-danger">*</span> </label>
                                <select required class="primary_select form-control" name="issuer" value="rubel" id="form-checkout__issuer"></select>
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6 mb_20">
                                ...
                                <select required class="primary_select form-control" name="identificationType"  id="form-checkout__identificationType"></select>
                            </div>
                            ...
                            <div class="col-xl-6 col-md-6 mb_20">
                                ...
                                <input required class="primary_input4 form-control" type="text" name="identificationNumber"  id="form-checkout__identificationNumber"/>
                            </div>

                            <div class="col-xl-6 col-md-6 mb_20">
                                <label for="form-checkout__installments" class="mb-2">{{ __('payment_gatways.installments') }}  <span class="text-danger">*</span> </label>
                                <select required class="primary_select form-control" name="installments" id="form-checkout__installments"></select>
                            ...
                            <div class="col-xl-12 col-md-12">
                                <div class="send_query_btn d-flex justify-content-between mt-4">
                                    ...
                                    <button  class="amaz_primary_btn style3 text-nowrap" type="submit" id="form-checkout__submit">{{ __('common.submit') }}</button>
                                </div>
                            </div>
                        </div>

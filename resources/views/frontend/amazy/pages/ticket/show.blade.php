...
<div class="col-xl-6 col-lg-6">
    <div class="dashboard_white_box style3 bg-white mb_25">
        ...
        <div class="ticket_view_box theme_border gray_color_1 radius_5px mb_10">
            ...
            <div class="ticket_view_box_body thumb">
                @foreach($ticket->attachFiles as $atachfile)
                <a href="{{showImage($atachfile->url)}}" download class="cursor-pointer">
                    <img src="{{showImage($atachfile->url)}}" alt="{{$ticket->subject}}" title="{{$ticket->subject}}" class="img-fluid">
                </a>
                @endforeach
                </div>
        </div>

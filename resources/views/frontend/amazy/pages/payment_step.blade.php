            ...
            $(document).ready(function() {
                $(document).on('change', 'input[type=radio][name=payment_method]', function(){
                    ...
                    if(method === 'cash-on-delivery'){
                        ...
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="CashOnDelivery" data-url="`+url+`" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.order_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    if(method === 'wallet'){
                        var url = baseUrl + '/checkout?gateway_id='+gateway_id+'&payment_id='+payment_id+'&step=complete_order';
                        $('#btn_div').html(`<a href="javascript:void(0)" data-url="`+url+`" id="payment_btn_trigger" data-type="Wallet" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }

                    if(method === 'stripe'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Stripe" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'bkash'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Bkash" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'sslCommerz'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="SslCommerz" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'mercado-pago'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Mercado Pago" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
                    else if(method === 'tabby'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Tabby" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
                    else if(method === 'ccavenue'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="CCAvenue" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
                    else if(method === 'paypal'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="PayPal" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'paystack'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="PayStack" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'razorpay'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="RazorPay" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'instamojo'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Instamojo" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
                    else if(method === 'paytm'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="PayTM" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
                    else if(method === 'midtrans'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Midtrans" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'payumoney'){

                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="PayUMoney" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
                    else if(method === 'jazzcash'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="JazzCash" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'google-pay'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Google Pay" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }
                    else if(method === 'flutterwave'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="FlutterWave" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }
                    else if(method === 'bank-payment'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Bank Payment" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }else if(method == 'clickpay'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="Clickpay" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                    }else if(method === 'ePayco'){
                        $('#btn_div').html(`<a href="javascript:void(0)" id="payment_btn_trigger" data-type="EPAYCO" class="amaz_primary_btn3 style3  min_200 text-center text-uppercase">{{__("hr.pay_now")}}</a>`);
                        $('#acc_'+id).addClass('d-none');
                    }

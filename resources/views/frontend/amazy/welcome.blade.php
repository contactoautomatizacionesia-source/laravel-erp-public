...
<style>
    ...
    /* Tarjeta Premium para la cuadrícula (Grid) en el Inicio */
    .premium-price-box {
        display: flex;
        ...
        overflow: hidden;
        margin-top: 12px;
        width: 100%; /* Obliga a la tarjeta a ponerse debajo del botón y usar todo el ancho */
        background: #fff;
        padding: 5px
    }
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="trending_product_active owl-carousel ofertas-imperdibles">
                    @foreach($best_deal->getProductByQuery() as $key => $product)
                        <div class="product_widget5 mb_30 style5">
                            ...
                            <div class="product__meta text-center">
                                @if(env('SEE_BRAND')=='true')
                                    <span class="product_banding ">{{ @$product->brand->name ?? " " }}</span>
                                @endif
                                <a href="{{singleProductURL(@$product->seller->slug, $product->slug)}}">
                                    <h4 class="mb-0">@if ($product->product_name) {{ textLimit(@$product->product_name, 50) }} @else {{ textLimit(@$product->product->product_name, 50) }} @endif</h4>
                                </a>


                                @if(isGuestAddtoCart() == true)
                                    <div class="product_price d-flex align-items-center justify-content-center flex-wrap">
                                        <a class="amaz_primary_btn addToCartFromThumnail rounded-3 py-1 px-2" data-producttype="{{ @$product->product->product_type }}" data-seller={{ $product->user_id }} data-product-sku={{ @$product->skus->first()->id }}
                                            @if (@$product->hasDeal)
                                        ...
                                        <div class="premium-price-box">
                                            ...
                                            <div class="normal-price-row">
                                                ...
                                                <span class="np-label">Precio normal</span>
                                            </div>

                                            <div class="platino-price-row d-flex align-items-center justify-content-center flex-column flex-md-row" title="Precio exclusivo con Plan PLATINO">
                                                <span class="pp-badge"><i class="ti-medall"></i> PLATINO -20%</span>
                                                <span class="pp-price">{{ single_price(@$product->skus->first()->sell_price * 0.8) }}</span>
                                            </div>
                                ...
                                @else
                                    <div class="product_price d-flex align-items-center justify-content-between flex-wrap rounded-3 ">
                ...
                <div class="col-xl-5 p-0 col-lg-12">
                    <div class="House_Appliances_widget">
                        <div class="House_Appliances_widget_left d-flex flex-column flex-fill">
                            <h4>{{$filter_category_1->title}}</h4>
                            <ul class="nav nav-tabs flex-fill flex-column border-0"  >
                                        ...
                                        <div class="product_widget5 style4 mb-0 style5">
                                            ...
                                            <div class="product__meta text-center">
                                                ...
                                                <div class="product_price d-flex align-items-center justify-content-between flex-wrap">
                                                    <a class="amaz_primary_btn addToCartFromThumnail rounded-3 p-2" data-producttype="{{ @$product->product->product_type }}" data-seller={{ $product->user_id }} data-product-sku={{ @$product->skus->first()->id }}
                                                        @if (@$product->hasDeal)
                                                            data-base-price={{ selling_price(@$product->skus->first()->sell_price,@$product->hasDeal->discount_type,@$product->hasDeal->discount) }}
                                                        @else
                                                            @if (@$product->hasDiscount == 'yes')
        ...
        @if($category)
            <div class="row no-gutters">
                <div class="col-xl-5 p-0 col-lg-12">
                    <div class="House_Appliances_widget">
                        <div class="House_Appliances_widget_left d-flex flex-column flex-fill">
                            <h4>{{$filter_category_2->title}}</h4>
                            <ul class="nav nav-tabs flex-fill flex-column border-0"  >
                                @foreach(@$category->subCategories as $key => $subcat)
                                <li class="nav-item" >
                                    <button class="nav-link {{$key == 0?'active':''}}" id="tab_link_{{$subcat->id}}" data-bs-toggle="tab" data-bs-target="#fashion_tab_pane_subcat_{{$subcat->id}}" type="button"  aria-controls="Dining" aria-selected="true">{{$subcat->name}}</button>
                                </li>
                                @endforeach
                            </ul>
                            <a href="{{route('frontend.category-product',['slug' => $category->slug, 'item' =>'category'])}}" class="title_link d-flex align-items-center lh-1">
        ...
        @if($category)
            <div class="row no-gutters">
                <div class="col-xl-5 p-0 col-lg-12">
                    <div class="House_Appliances_widget">
                        <div class="House_Appliances_widget_left d-flex flex-column flex-fill">
                            <h4>{{$filter_category_3->title}}</h4>
                            <ul class="nav nav-tabs flex-fill flex-column border-0"  >
                                @foreach(@$category->subCategories as $key => $subcat)
                                <li class="nav-item" >
                                    <button class="nav-link {{$key == 0?'active':''}}" id="tab_link_{{$subcat->id}}" data-bs-toggle="tab" data-bs-target="#electronics_tab_pane_subcat_{{$subcat->id}}" type="button"  aria-controls="Dining" aria-selected="true">{{$subcat->name}}</button>
                                </li>
                                @endforeach
                            </ul>
                            <a href="{{route('frontend.category-product',['slug' => $category->slug, 'item' =>'category'])}}" class="title_link d-flex align-items-center lh-1">
        ...
        <div class="row">
            <div class="col-12">
                <ul class="nav amzcart_tabs d-flex align-items-center justify-content-center flex-wrap " id="myTab" >
                    <li class="nav-item {{$top_rating->status == 0 ? 'd-none' : ''}}"  id="top_rating">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button"  aria-controls="home" ><span id="top_rating_title">{{$top_rating->title}}</span></button>
                    </li>
                    <li class="nav-item {{$peoples_choice->status == 0 ? 'd-none' : ''}}"  id="people_choices">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button"  aria-controls="profile" ><span id="people_choice_title">{{$peoples_choice->title}}</span></button>
                    </li>
                    <li class="nav-item {{$top_picks->status == 0 ? 'd-none' : ''}}"  id="top_picks">
                        <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button"  aria-controls="contact" ><span id="top_picks_title">{{$top_picks->title}}</span></button>
                    </li>
                </ul>
            </div>
            <div class="col-xl-12">
...
<div id="discount_banner" class="amaz_section amaz_deal_area {{$discount_banner->status == 0?'d-none':''}}">
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xl-2 col-md-4 col-lg-3 mb_20 {{!@$discount_banner->customSection->field_4?'d-none':''}}">
            ...
            <div class="col-xl-2 col-md-4 col-lg-3 mb_20 {{!@$discount_banner->customSection->field_5?'d-none':''}}">
            ...
            <div class="col-xl-2 col-md-4 col-lg-3 mb_20 {{!@$discount_banner->customSection->field_6?'d-none':''}}">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 text-center">
                ...
                <a id="loadmore" class="amaz_primary_btn2 min_200 load_more_btn_homepage rounded-3">{{__('common.load_more')}}</a>
                @endif

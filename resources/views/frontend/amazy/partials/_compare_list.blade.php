<div class="col-xl-10">
    <div class="compare_title_div mb_30 flex-column flex-md-row mb-2 mb-md-0">
        <h3 class="fs-4 fw-bold mb-0">{{ __('defaultTheme.product_compare') }}</h3>
        @if(count($products) > 0)
            <a href="#" class="amaz_primary_btn style3 px-3">{{ __('defaultTheme.reset_compare') }}</a>
        @endif
    </div>
    <div class="comparing_box_area mb_30">
        ...
        <div class="compare_product_descList">
            ...
            <div class="single_product_list product_tricker compare_product">
                ...
                <ul class="comparison_lists comparation-labels style2">
                    <li>
                        {{__('common.name')}}
                    </li>
                    <li>
        ...
        <div class="compare_product_carousel cart-shadown">

<head>
    ...
    <style>
        :root {
            ...
            --ornage_color:#d96d00;
            --background-footer: url('{{ showImage(app('general_setting')->footer_background) }}');
    ...
    <script>
         ...
         * Injected server-side for internationalization of UI elements
         * Used by nice-select patch and other JS components
         */
        globalThis.AppLang = {

                                    ...
                                    @php
                                        ...
                                        if(count($gateway_activations) > 0 && $gateway_activations[0]->id == 1 || count($gateway_activations) > 0 && $gateway_activations[0]->id == 2){
                                            ...
                                            if($gateway_activations[0]->id == 1){
                                                ...
                                                $pay_now_btn = '<a href="javascript:void(0)" data-url="'.$url.'" data-type="CashOnDelivery" id="payment_btn_trigger" class="amaz_primary_btn3 style3 text-center text-uppercase">Pay now</a>';
                                            }elseif($gateway_activations[0]->id == 2){
                                                $url = url('/checkout?').'gateway_id='.$gateway_id.'&payment_id='.$payment_id.'&step=complete_order';
                                                $pay_now_btn = '<a href="javascript:void(0)" data-url="'.$url.'" data-type="Wallet" id="payment_btn_trigger" class="amaz_primary_btn3 style3 text-center text-uppercase">Pay now</a>';
                                            }
                                        }else {
                                            $method = '';
                                            ...
                                            $pay_now_btn = '<a href="javascript:void(0)" id="payment_btn_trigger" data-type="'.$method.'" class="amaz_primary_btn3 style3 text-center text-uppercase">Pay now</a>';
                                        }
                                    @endphp
                                    {!! $pay_now_btn !!}
                                </div>
                ...
                @auth
                    ...
                    @if(\Session::has('coupon_type')&&\Session::has('coupon_discount'))
                        ...
                        <div class="coupon_verify_information mb_20 d-flex align-items-center flex-wrap ">
                            <div class="icon">
                                <img src="{{url('/')}}/public/frontend/amazy/img/cart/verified.svg" alt="">
                            </div>
                            <div class="coupon_content">
                                <h4 class="font_14 f_w_700 lh-1">Valid Coupon Code</h4>
                                <a class="remove_coupon text-uppercase text-decoration-underline cursor_pointer" id="coupon_delete">Remove Code</a>
                            </div>
                        </div>
                    @else

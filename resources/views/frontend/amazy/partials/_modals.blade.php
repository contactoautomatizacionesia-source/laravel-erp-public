            ...
            <!-- infix_login_area::start  -->
                <div class="infix_login_area p-0">
                    <div class="login_area_inner">
                        <h3 class="sign_up_text mb_20 fs-5">{{__('amazy.have_a_question')}}?</h3>
                        <form action="#">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-12">
                                    <button class="home10_primary_btn2 text-center f_w_700">{{__('defaultTheme.send_message')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="login_area_inner">
                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <button class="amaz_primary_btn style2 radius_5px w-100 text-uppercase text-center">{{ __('auth.Sign Up') }}</button>
                                </div>
                                <div class="col-12">
                                    <p class="sign_up_text text-center" >{{ __('defaultTheme.already_have_account') }} <a data-bs-toggle="modal" data-bs-dismiss="modal" href="#" data-bs-target="#checkot_login_form" >{{ __('common.login') }}</a></p>
                                </div>
                            </div>
                        </form>
                    </div>

@php
    ...
    foreach ($cartData as $key => $items) {
        ...
        foreach ($items as $key => $data) {
            ...
            $total_points += (float) ($data->total_club_point ?? 0);
            if ($data->is_select == 1) {
...
<div class="container pt-3 bg-white">
    <div class="row">
                    ...
                    <div class="checkout_v3_inner w-100">
                        ...
                        @if(!isModuleActive('MultiVendor'))
                            ...
                            <div class="amazy_table4">
                                <div class="amazy_table4_head mb_20 d-none d-lg-flex rounded-10  cart-shadown">
                                    <div class="row d-none d-lg-flex flex-fill">
                                        ...
                                        <div class="col fw-600"> <h4 class="font_14 f_w_700 m-0 text-nowrap priamry_text text-uppercase">{{__('common.points')}}</h4> </div>
                                ...
                                <ul class="amazy_table4_body rounded-10 cart-shadown">
                                                ...
                                                <li class="list-group-item px-0 px-lg-3 mb_10">
                                                    <div class="row gutters-5 align-items-center m-0">
                                                                    ...
                                                                    <div class="d-flex flex-wrap align-items-center gap-10 mt-3">
                                                                        ...
                                                                        <div class="d-inline">
                                                                            <h4 class="font_16 f_w_700 m-0 lh-1 d-inline d-lg-none text-nowrap">
                                                                                {{single_price($cart->total_price)}} | {{0}}
                                                                            </h4>
                                                        ...
                                                        <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0 d-none d-lg-block">
                                                            <h6>
                                                                <span id="total_points_modal" class="text-dark" data-base-points="0">{{ getNumberTranslate($cart->total_club_point) }}</span>
                                                            </h6>
                                                        </div>
                                                        <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0 d-none d-lg-block">
                        ...
                        @endif
                        <div class="d-flex gap_10 align-items-center flex-wrap mt_20 justify-content-center justify-content-md-start">
                            <div class="d-none d-lg-flex align-items-center gap_10 flex-fill flex-wrap">
                                <a href="{{url('/')}}" class="amaz_primary_btn3 style3">{{__('defaultTheme.continue_shopping')}}</a>
                            </div>
                            <a class="amaz_primary_btn min_200 style3 cursor_pointer px-4 @if (count($cartData) > 0) process_to_checkout_check @endif" data-value="{{$selected_product_check}}">{{__('defaultTheme.proceed_to_checkout')}}</a>
                        </div>
                    </div>
                <!-- for wholesale module -->
        ...
        <div class="col-12 checkout_v3_right d-flex justify-content-start checkout_summery_div">
            @php

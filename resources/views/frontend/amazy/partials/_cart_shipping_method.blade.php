            ...
            <div class="modal-body">
                ...
                <div class="row mt_60 mb_20">
                    <div id="list_div" class="col-md-12">
                        <div class="address_list_div table-responsive" id="address_list_div">
                            <table class="table table-hover tablesaw tablesaw-stack text-center shipping_modal_table">
                                <thead>
                                    <tr class="">
                                        <th>{{__('shipping.estimated_delivery')}}</th>
                                    ...
                                    @foreach($shipping_methods as $key => $shipping)
                                        ...
                                        <tr class="custom_tr">
                                            <td>
                                                ...
                                                <p class="f_s_14 f_w_400 m-0  selected_shipping_text">{{__('shipping.estimated_delivery_time')}}: {{getNumberTranslate($shipping->shipment_time_label)}}</p>
                                                </div>
                                            </td>

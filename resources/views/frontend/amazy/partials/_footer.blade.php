...
<!-- FOOTER::START  -->
    <footer class="home_three_footer bg-footer">
                 ...
                 <div class="row footer-flex">
                    <div class="col-xl-3 col-lg-3 col-md-6 footer_links_50 ">
                        <div class="header__left d-flex align-items-center">
                            <div class="logo_img">
                                <a href="{{ url('/') }}">
                                     <img src="{{ showImage(app('general_setting')->logo_light) }}" alt="{{ app('general_setting')->company_name }}" title="{{ app('general_setting')->company_name }}"> 
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    @if ($footer_content->show_play_store || $footer_content->show_app_store)
        ...
        <div class="copyright_area p-0">
            <div class="container copy bg-color-base">

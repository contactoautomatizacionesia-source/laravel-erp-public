   ...
   <div class="container banner-section-container mt-4">
    <div class="row">
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="single-banner-item">
                        <img src="{{asset('public/frontend/default/img/banner/banner1.png')}}" class="w-100" alt="banner">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-6">
                    <div class="single-banner-item">
                        <img src="{{asset('public/frontend/default/img/banner/banner2.png')}}" class="w-100" alt="banner">
                    </div>
                </div>
                <div class="col-md-6 col-6">
                    <div class="single-banner-item">
                        <img src="{{asset('public/frontend/default/img/banner/banner3.png')}}" class="w-100" alt="banner">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-4">
            <div class="single-banner-item">
                <img src="{{asset('public/frontend/default/img/banner/banner4.png')}}" class="w-100" alt="banner">
            </div>
        </div>
    </div>
  </div>
        ...
        <div class="category-list-container">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 category-item">
                <div class="category-image">
                    <img src="https://placehold.co/400" alt="category">
                </div>

                                        ...
                                        @if(!isModuleActive('MultiVendor'))
                                            ...
                                            @foreach($shipping_methods->where('id','>',1)->where('request_by_user', 1) as $key => $shipping)
                                                @php
                                                    ...
                                                    $total_check = $cost + $totalItemPrice;
                                                @endphp
                                                        ...
                                                        <ul>
                                                            <li class="mb-0">
                                                                <label class="primary_bulet_checkbox">
                                                                    <input type="radio" data-cost="{{$cost}}" class="shipping_method" name="shipping_method" value="{{encrypt($shipping->id)}}" {{$shipping->id == $skip_method?'checked':''}}>

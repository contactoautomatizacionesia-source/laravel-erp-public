                        ...
                        <div class="cartv2_product_single d-flex mb_10">
                            <div class="cartv2_product_body_left d-flex align-items-center">
                                ...
                                <div class="product_info">
                                    ...
                                    @endphp
                                    <span class="Shipping_text {{@$data->product->product->product->is_physical == 1?'shipping_show':''}}" data-id="#shipping_method_modal_{{$data->id}}"> <span>{{__('common.shipping')}}: {{single_price($current_shipping->cost)}} </span> via {{substr($current_shipping->method_name,0,11) }} @if(strlen($current_shipping->method_name) > 11)... @endif - {{@$current_shipping->shipment_time_label}} <i class="ti-angle-right"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="cartv2_product_single d-flex mb_10">
                            <div class="cartv2_product_body_left d-flex align-items-center">
                                ...
                                <div class="product_info">
                                    ...
                                    <span class="Shipping_text"> <span>{{__('common.shipping')}}: {{single_price(@$shipping_methodGiftCard->cost)}} </span> via {{substr($shipping_methodGiftCard->method_name,0,11)}} @if(strlen($shipping_methodGiftCard->method_name) > 11)... @endif - {{@$shipping_methodGiftCard->shipment_time_label}} <i class="ti-angle-right"></i></span>
                                </div>
                            </div>
                            <div class="cartv2_product_body_right d-flex align-items-center">
                                <div class="prise_heiglite d-flex align-items-center gap_10">

<?php return [
    ...
    'double_approval_process' => 'Double Approval Process',
    'confirm_message' => 'This action requires a double approval. The changes will be applied once the second user approves the request.',

...
Route::middleware(['admin','auth'])->prefix('frontendcms')->as('frontendcms.')->group(function() {
    ...
    //feature
    Route::resource('features', 'FeatureController')->only(['index', 'create', 'show']);
    ...
    Route::get('/promotion-bar/remove-image','PromotionbarController@removeImage')->name('promotionbar.removeImage');
    // ads bar
    ...
    Route::resource('/dynamic-page', 'DynamicPageController')->only(['index', 'create', 'show', 'edit']);
...
Route::middleware(['admin','auth'])->prefix('admin')->as('admin.')->group(function(){
    //pricing
    Route::resource('/pricing', 'PricingController')->only(['index', 'create', 'show', 'edit', 'store']);

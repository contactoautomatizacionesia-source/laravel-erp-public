        ...
        (function($){
            $(document).ready(function(){
                ...
                $(document).on('shown.bs.collapse', '.collapse', function () {
                    $(this).css('visibility', 'visible');
                    // Solo actualizamos los selects básicos, IGNORANDO los que usan Select2
                    $(this).find('.primary_select, .edit_size, .edit_page, .edit_function, .edit_menu').niceSelect('update');
                });

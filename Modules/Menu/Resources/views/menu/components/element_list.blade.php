        ...
        <div id="itemDiv" class="row">
            ...
            <div class="col-lg-12 card mb-10 column_header_div" data-id="{{$column->id}}">
                <div class="card-header card_header" id="accordion_column_{{$column->id}}">
                    ...
                    <div class="mt-20 column_edit_div collapse" id="collapse_column_{{$column->id}}" aria-labelledby="heading_column_{{$column->id}}">
                    ...
                    <div class="col-lg-12 single_item" data-id="{{$element->id}}" >
                        <div class="mb-10">
                            <div class="card" id="accordion_{{$element->id}}">
                                ...
                                <div id="collapse_{{$element->id}}" class="collapse" aria-labelledby="heading_{{$element->id}}" >
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" class="elementEditForm" data-element_type= "{{$element->type}}" data-element_id= "{{$element->id}}">
                                            <div class="row">

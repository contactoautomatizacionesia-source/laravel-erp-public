                    ...
                    <div class="col-lg-12">
                        <div id="accordion_create">
                            <div class="card">
                                ...
                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion_create">
                                    <div class="card-body">
                                        <form id="add_row_btn">
                            ...
                            <div class="card mb-10 mt-10">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion_create">
                                    <div class="card-body">

...
@php($general_setting = app('general_setting'))
@section('styles')
<style>
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                   ...
                                                                                                   value="1"
                                                                                                   @if ($general_setting->preloader_status == 1) checked @endif>
                                                                                            <span
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                   ...
                                                                                                   id="database"
                                                                                                   name="preloader_status"
                                                                                                   @if ($general_setting->preloader_status == 0) checked
                                                                                                   @endif
                                                                                                   value="0" >
                                                                                            <span
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                   ...
                                                                                                   name="preloader_type"
                                                                                                   value="1"
                                                                                                   @if (!$general_setting->preloader_type || $general_setting->preloader_type == 1) checked @endif>
                                                                                            <span
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <label
                                                                                            ...
                                                                                            <input type="radio"
                                                                                                   ...
                                                                                                   id="preloader_type2"
                                                                                                   name="preloader_type"
                                                                                                   @if ($general_setting->preloader_type == 2) checked
                                                                                                   @endif
                                                                                                   value="2">
                                                                                            <span
                                                                            ...
                                                                            <div class="col-xl-2">
                                                                                <div class="primary_input mb-25 pt-4 banner_img_div">
                                                                                    <img
                                                                                         ...
                                                                                         src="{{showImage($general_setting->preloader_image?$general_setting->preloader_image:$general_setting->favicon)}}"
                                                                                         alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row pt-2">
                                                                            <div class="col-md-2">
                                                                                <input type="radio"
                                                                                       ...
                                                                                       {{$general_setting->preloader_style==25?'checked':''}}
                                                                                       value="25"/>
                                                                                <label for="checkbox25">
                                                                                    <div
                                                                                        class="preloaderr lifehuni-preloader-wrapper {{$general_setting->preloader_style==25?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div class="lifehuni-preloader-circle"></div>

                                                                                            <div class="lifehuni-preloader-leaf">
                                                                                                <img src="{{showImage($general_setting->favicon)}}" alt="{{ $general_setting->site_title }}">
                                                                                            </div>

                                                                                            <span class="lifehuni-preloader-text">{{ $general_setting->site_title }}</span>
                                                                                    </div>
                                                                                </label>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <input type="radio"
                                                                                       id="checkbox26"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==26?'checked':''}}
                                                                                       value="26"/>
                                                                                <label for="checkbox26">
                                                                                    <div
                                                                                        class="preloaderr lifehuni-pulse-wrapper {{$general_setting->preloader_style==26?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div class="lifehuni-pulse-ring ring-1"></div>
                                                                                        <div class="lifehuni-pulse-ring ring-2"></div>
                                                                                        <div class="lifehuni-pulse-ring ring-3"></div>

                                                                                        <div class="lifehuni-pulse-center">
                                                                                            <img src="{{ showImage($general_setting->favicon) }}" alt="{{ $general_setting->site_title }}" width="48">
                                                                                        </div>

                                                                                        <span class="lifehuni-pulse-text">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio"
                                                                                       id="checkbox27"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==27?'checked':''}}
                                                                                       value="27"/>
                                                                                <label for="checkbox27">
                                                                                    <div
                                                                                        class="preloaderr lifehuni-flow-wrapper {{$general_setting->preloader_style==27?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div class="lifehuni-flow-orbit">
                                                                                            <span class="lifehuni-dot d1"></span>
                                                                                            <span class="lifehuni-dot d2"></span>
                                                                                            <span class="lifehuni-dot d3"></span>
                                                                                        </div>

                                                                                        <div class="lifehuni-flow-center">
                                                                                            <img src="{{ showImage($general_setting->favicon) }}" alt="{{ $general_setting->site_title }}" width="44">
                                                                                        </div>

                                                                                        <span class="lifehuni-flow-text">
                                                                                            {{ $general_setting->site_title }}
                                                                                        </span>
                                                                                    </div>
                                                                                </label>
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox0"
                                                                                       name="preloader_style"
                                                                                       {{!$general_setting->preloader_style || $general_setting->preloader_style == 0?'checked':''}}
                                                                                       value="0"/>
                                                                                <label for="checkbox0">
                                                                                    <div
                                                                                        class="preloaderr {{!$general_setting->preloader_style||$general_setting->preloader_style==0?'active':''}}"
                                                                                        dir="ltr">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox1"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==1?'checked':''}}
                                                                                       value="1"/>
                                                                                <label for="checkbox1">
                                                                                    <div
                                                                                        class="preloaderr  {{$general_setting->preloader_style==1?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox2"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==2?'checked':''}}
                                                                                       value="2"/>
                                                                                <label for="checkbox2">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==2?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox3"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==3?'checked':''}}
                                                                                       value="3"/>
                                                                                <label for="checkbox3">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==3?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox4"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==4?'checked':''}}
                                                                                       value="4"/>
                                                                                <label for="checkbox4">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==4?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox5"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==5?'checked':''}}
                                                                                       value="5"/>
                                                                                <label for="checkbox5">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==5?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox6"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==6?'checked':''}}
                                                                                       value="6"/>
                                                                                <label for="checkbox6">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==6?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox7"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==7?'checked':''}}
                                                                                       value="7"/>
                                                                                <label for="checkbox7">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==7?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox8"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==8?'checked':''}}
                                                                                       value="8"/>
                                                                                <label for="checkbox8">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==8?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox9"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==9?'checked':''}}
                                                                                       value="9"/>
                                                                                <label for="checkbox9">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==9?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox10"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==10?'checked':''}}
                                                                                       value="10"/>
                                                                                <label for="checkbox10">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==10?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox11"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==11?'checked':''}}
                                                                                       value="11"/>
                                                                                <label for="checkbox11">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==11?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox12"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==12?'checked':''}}
                                                                                       value="12"/>
                                                                                <label for="checkbox12">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==12?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox13"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==13?'checked':''}}
                                                                                       value="13"/>
                                                                                <label for="checkbox13">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==13?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox14"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==14?'checked':''}}
                                                                                       value="14"/>
                                                                                <label for="checkbox14">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==14?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox15"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==15?'checked':''}}
                                                                                       value="15"/>
                                                                                <label for="checkbox15">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==15?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox16"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==16?'checked':''}}
                                                                                       value="16"/>
                                                                                <label for="checkbox16">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==16?'active':''}}"
                                                                                        dir="ltr">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox17"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==17?'checked':''}}
                                                                                       value="17"/>
                                                                                <label for="checkbox17">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==17?'active':''}}"
                                                                                        dir="ltr">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox18"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==18?'checked':''}}
                                                                                       value="18"/>
                                                                                <label for="checkbox18">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==18?'active':''}}"
                                                                                        dir="ltr">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox19"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==19?'checked':''}}
                                                                                       value="19"/>
                                                                                <label for="checkbox19">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==19?'active':''}}"
                                                                                        dir="ltr">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio" id="checkbox20"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==20?'checked':''}}
                                                                                       value="20"/>
                                                                                <label for="checkbox20">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==20?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio"
                                                                                       id="checkbox21"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==21?'checked':''}}
                                                                                       value="21"/>
                                                                                <label for="checkbox21">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==21?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio"
                                                                                       id="checkbox22"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==22?'checked':''}}
                                                                                       value="22"/>
                                                                                <label for="checkbox22">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==22?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <input type="radio"
                                                                                       id="checkbox23"
                                                                                       name="preloader_style"
                                                                                       {{$general_setting->preloader_style==23?'checked':''}}
                                                                                       value="23"/>
                                                                                <label for="checkbox23">
                                                                                    <div
                                                                                        class="preloaderr {{$general_setting->preloader_style==23?'active':''}}"
                                                                                        dir="ltr">
                                                                                        <div

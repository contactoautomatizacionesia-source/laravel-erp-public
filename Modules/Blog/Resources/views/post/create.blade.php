...
<style>
    .laraberg__editor input[type="checkbox"], .laraberg__editor input[type="color"], .laraberg__editor input[type="date"], .laraberg__editor input[type="datetime-local"], .laraberg__editor input[type="datetime"], .laraberg__editor input[type="email"], .laraberg__editor input[type="month"], .laraberg__editor input[type="number"], .laraberg__editor input[type="password"], .laraberg__editor input[type="radio"], .laraberg__editor input[type="search"], .laraberg__editor input[type="tel"], .laraberg__editor input[type="text"], .laraberg__editor input[type="time"], .laraberg__editor input[type="url"], .laraberg__editor input[type="week"], .laraberg__editor select, .laraberg__editor textarea {
                        ...
                        <div class="row">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="element{{$language->code}}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <textarea class="summernote_{{$language->code}}" name="content[{{$language->code}}]">{{ old('content.'.$language->code)}}</textarea>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
                                    ...
                                    placeholder="{{ __('common.title') }}" type="text" autocomplete="off" value="{{old('title')}}">
                                </div>
                                @if ($errors->has('title'))
        ...
        (function($){
            ...
            $(document).ready(function () {
                @if(isModuleActive('FrontendMultiLang'))
                    ...
                    @foreach ($LanguageList as $key => $language)
                    $('.summernote_{{$language->code}}').summernote({
                        height: 200,
                        codeviewFilter: true,
                        ...
                        callbacks: {
                            onImageUpload: function (files) {
                                sendFile(files, '.summernote_{{$language->code}}')
                            }
                        }
                    });
                    @endforeach

<div class="row">
    ...
    @if(\Session::has('inhouse_order_shipping_address'))
        <div class="col-lg-8">
            ...
            @endphp
            <h4>{{__('shipping.shipping_address')}}</h4>
            <table class="direction_table table-borderless clone_line_table">
                ...
                <tr>
                    ...
                    <td> {{$shipping_address['shipping_postcode']}}</td>
                </tr>
            </table>
            ...
            @endphp
            <h4>{{__('common.billing_address')}}</h4>
            <table class="direction_table table-borderless clone_line_table">
                <tr>
                    <td>{{__('common.name')}}</td>
                ...
                <tr>
                    <td>{{ __('common.postcode') }}</td>
                    <td> {{$billing_address['billing_postcode']}}</td>
                </tr>
            </table>
            @else
        ...
        <div class="col-lg-4">
            <a href="" id="resetAddress" class=" btn-toolkit btn-primary btn-icon">{{ __('shipping.reset_address') }}

            </a>
        </div>
    @else
    <div class="col-lg-12">
        <h4>{{ __('common.shipping_address_info') }} </h4>
    </div>
    <div class="col-lg-6">
    ...
    <div class="col-lg-6">
        <div class="primary_input mb-25">
            <label class="primary_input_label" for="postcode">{{ __('common.postcode') }} @if($postcodeRequired)<span class="text-danger">*</span>@endif</label>
    ...
    <div class="col-lg-12 billing_address_field d-none">
        <div class="primary_input mb-25">
            <label class="primary_input_label" for="name"><h4>{{ __('common.billing_address_info') }} </h4></label>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <button id="save_address_btn" type="button" class=" btn-toolkit btn-primary btn-icon"

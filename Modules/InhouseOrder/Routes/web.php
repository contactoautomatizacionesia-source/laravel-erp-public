...
Route::prefix('admin/in-house-order')->middleware(['auth', 'admin'])->as('admin.inhouse-order.')->group(function() {

    // inhouse order
    Route::get('/', 'InhouseOrderController@index')->name('index')->middleware(['permission']);
    Route::get('/get-data', 'InhouseOrderController@getData')->name('get-data');
    ...
    Route::get('/get-customer-info', 'InhouseOrderController@getCustomerInfo')->name('get-customer-info');
    Route::get('/save-representative', 'InhouseOrderController@saveRepresentative')->name('save-representative');
});

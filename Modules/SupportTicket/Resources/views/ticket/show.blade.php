            ...
            <div class="col-12">
                <div class="box_header common_table_header">
                    <div class="main-title">
                        <h3 class="mb-0 mr-30"> {{getNumberTranslate($SupportTicket->reference_no)}} - {{$SupportTicket->subject}}</h3>
                    </div>
                ...
                <div class="white_box_30px mb-30">
                    <div class="info_list_wrap p-0">
                        ...
                        <div class="project_info_list mb-50">
                            ...
                            <div class="single_project_list d-flex">
                                ...
                                <div class="project_info_name project_info_content">
                                    {{getNumberTranslate($SupportTicket->reference_no) }}
                                </div>
                            </div>
                            <!-- single_project_list  -->
                            <div class="single_project_list d-flex">
                        ...
                        <div class="primary_input mb-25">
                            ...
                            <a class="primary_input_gray form-control pt-15" href="{{ URL::to('/') }}/{{ asset_path($file->url) }}" target="_blank"> {{  $key+1 }} .
                            ...
                            <div class="tickets_view_lists mb-50">
                                ...
                                <div class="comments_checklisted">
                                    ...
                                    <div class="msg_attach_file_list d-block">
                                        ...
                                        <a href="{{ URL::to('/') }}/{{ asset_path($file->url) }}" target="_blank">{{  $key+1 }} .
                                            {{ strlen($file->name) > 20 ? substr($file->name, 0,20) . '...' . $file->type : $file->name }}</a>
                                        @endforeach
                                        @endif

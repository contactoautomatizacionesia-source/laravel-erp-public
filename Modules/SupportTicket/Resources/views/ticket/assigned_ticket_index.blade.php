...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
        <div class="row mx-0">
            ...
            <div class="col-lg-12 white_box_30px mt-10">
            ...
            <input type="hidden" name="url" id="this_url" @if(strpos($_SERVER['REQUEST_URI'], '?') == true) value="{{explode('?',$_SERVER['REQUEST_URI'])[1]}}" @else value="0" @endif>
        </div>
    </div>
</section>

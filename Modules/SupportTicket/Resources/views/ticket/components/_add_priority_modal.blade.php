<div class="modal fade admin-query" id="priorityCreateModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{__('ticket.add_new_priority')}}</h4>
                <button type="button" class="close" data-dismiss="modal"><i class="ti-close "></i></button>
            </div>
            <form method="POST" id="add_priority_form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span class="text-danger" id="error_priority_name"></span>

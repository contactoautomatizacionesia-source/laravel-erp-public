...
<!-- End of KEditor styles -->
    ...
    <style data-type="keditor-style">
        :root {
            ...
            --base_color_2: #75aa50;/*{{ $themeColor->base_color_2 }}*/
            --base_color_3: #4e632c;/*{{ $themeColor->base_color_3 }}*/
            --btn_secondary_color: #ffc926;/*{{ $themeColor->btn_secondary_color }}*/
            --text-secondary-color: #1b2b61;/*{{ $themeColor->text-secondary-color }}*/
        }
        .default_select{

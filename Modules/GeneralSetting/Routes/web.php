...
Route::middleware(['auth','admin'])->prefix('generalsetting')->group(function () {
    ...
    Route::get('/dian-configuration', 'DianSettingsController@index')->name('dian_settings.index')->middleware(['permission']);

    /** Parameter settings */
    // Listar parámetros
    Route::get('/parameter-settings', 'ParameterSettingController@index')->name('parameter_settings.index')->middleware(['permission']);
    // Actualización de estado activo de parámetro
    Route::post('/parameter-settings', 'ParameterSettingController@update_active_status')->name('parameter_settings.update_active_status')->middleware(['permission']);
    // Actualización de parámetros
    Route::post('/parameter-settings-update/{id}', 'ParameterSettingController@update')->name('parameter_settings.update')->middleware(['permission']);
    // Eliminación de parámetros
    Route::delete('/parameter-settings-delete/{id}', 'ParameterSettingController@destroy')->name('parameter_settings.destroy')->middleware(['permission']);

    // SYSTEM CATALOG
    Route::get('/catalogs', 'SystemCatalogController@index')->name('admin.catalogs.index');
    Route::get('/catalogs/datatable', 'SystemCatalogController@datatable')->name('admin.catalogs.datatable');
    Route::post('/catalogs/store', 'SystemCatalogController@store')->name('admin.catalogs.store');
    Route::delete('/catalogs/{id}', 'SystemCatalogController@destroy')->name('admin.catalogs.destroy');
});

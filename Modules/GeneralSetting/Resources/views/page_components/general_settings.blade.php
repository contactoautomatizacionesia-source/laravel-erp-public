...
<form action="{{ route('company_information_update') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="General_system_wrap_area row">
        <div class="single_system_wrap col-lg-4">
            ...
            {{-- Nuevo logo ligth --}}
            <div class="single_system_wrap_inner text-center bg-dark">
                <div class="logo">
                    <span>{{ __('general_settings.system_logo_light') }}</span>
                </div>
                <div class="logo_img_div">
                    <img src="{{showImage(app('general_setting')->logo_light?app('general_setting')->logo_light:'backend/img/default.png') }}" alt="" id="generalSettingLogoLight">
                </div>
                <div class="update_logo_btn">
                    <button type="button" class="primary-btn small fix-gr-bg ">
                        <input placeholder="{{ __('general_settings.upload_logo') }}" type="file" accept="image/*" name="site_logo_light" id="site_logo_light">
                        {{ __('general_settings.upload_logo') }}
                    </button>
                </div>
            ...
            <div class="single_system_wrap_inner text-center">
                <div class="logo">
                    <span>{{ __('general_settings.footer_bg') }}<small>({{getNumberTranslate(1920)}} X {{getNumberTranslate(500)}}){{__('common.px')}}</small></span>
                </div>
                <div class="logo_img_div">
                    <img src="{{showImage(app('general_setting')->footer_background?app('general_setting')->footer_background:'backend/img/default.png') }}" alt="" id="generalSettingBgFooter">
                </div>
                <div class="update_logo_btn">
                    <button type="button" class="primary-btn small fix-gr-bg ">
                        <input placeholder="{{ __('general_settings.upload_logo') }}" type="file" accept="image/*" name="bg_footer" id="bg_footer">
                        {{ __('general_settings.upload_logo') }}
                    </button>
                </div>
        ...
        <div class="single_system_wrap col-lg-8">
            <div class="form-card">
                <h3>{{__('common.general')}}</h3>
                <div class="row">
                    <div class="col-xl-12">
                            ...
                            <ul  class="permission_list sms_list ">
                                <li>
                                    <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                        <input name="price_with_vat"  value="1" class="active" type="radio" {{(app('general_setting')->price_with_vat == 1)?'checked':''}}>
                                ...
                                <li>
                                    <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                        <input name="price_with_vat"  value="0" class="de_active" type="radio" {{(app('general_setting')->price_with_vat == 0)?'checked':''}}>
                                        <span class="checkmark"></span>
                                    </label>
                                    <p>{{ __('common.no') }}</p>
                                </li>
            ...
            <div class="form-card">
                ...
                <div class="row">
                            ...
                            <ul  class="permission_list sms_list ">
                                <li>
                                    <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                        ...
                                        <span class="checkmark"></span>
                                        <p class="ml-2"> {{__('general_settings.Multi vendor') }}</p>
                                    </label>
                                </li>
                                <li>
                                    <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                        ...
                                        <span class="checkmark"></span>
                                        <p class="ml-2">{{__('general_settings.Single Vendor') }}</p>
                                    </label>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="password_change_freq">
                                {{ __('general_settings.password_change_frequency') }}
                            </label>
                            <select class="primary_select mb-25" name="password_change_freq" id="password_change_freq">

                                {{-- Iteramos sobre el arreglo estático del Modelo --}}
                                @foreach (\Modules\GeneralSetting\Entities\GeneralSetting::getPasswordChangePeriods() as $days => $label)
                                    <option value="{{ $days }}" {{ app('general_setting')->password_change_freq == $days ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            ...
                            <p class="text-muted">
                                <small>{{ __('general_settings.password_change_frequency_hint') }}</small>
                            </p>
                        </div>
                    </div>
                    <div class="col-xl-6 mt-1">
                    ...
                    <div class="col-xl-6 mt-1">
                        <div class="primary_input">
                            <label class="primary_input_label" for="">
                                {{ __('general_settings.protecdata_enabled') }}
                            </label>
                            <ul class="permission_list sms_list ">
                                <li>
                                    <label data-id="bg_option" for="protecdata_enabled_yes" class="primary_checkbox d-flex mr-12 extra_width">
                                        <input name="protecdata_enabled" id="protecdata_enabled_yes" value="1" class="active" type="radio" {{ app('general_setting')->protecdata_enabled == 1 ? 'checked' : '' }}>
                                        <span class="checkmark"></span>
                                    </label>
                                    <p>{{ __('common.active') }}</p>
                                </li>
                                <li>
                                    <label data-id="color_option" for="protecdata_enabled_no" class="primary_checkbox d-flex mr-12 extra_width">
                                        <input name="protecdata_enabled" id="protecdata_enabled_no" value="0" class="de_active" type="radio" {{ app('general_setting')->protecdata_enabled == 0 ? 'checked' : '' }}>
                                        <span class="checkmark"></span>
                                    </label>
                                    <p>{{ __('common.inactive') }}</p>
                                </li>
            ...
            <div class="form-card">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 mt-1">
                        <div class="primary_input">
                            <label class="primary_input_label" for="">
                                {{ __('general_settings.send_digital_product_auto_send') }}
                            </label>
                            <ul  class="permission_list sms_list ">
                                <li>
                                    <label data-id="bg_option" for="send_digital_product" class="primary_checkbox d-flex mr-12 extra_width">
                                        <input name="send_digital_product" id="send_digital_product" {{ app('general_setting')->send_digital_product == 1 ? 'checked':'' }} value="1" class="active status" type="radio">
                                        <span class="checkmark"></span>
                                    </label>
                                    <p>{{ __('common.yes') }}</p>
                                </li>
                                <li>
                                    <label data-id="color_option" for="send_digital_product_no" class="primary_checkbox d-flex mr-12 extra_width">
                                        <input name="send_digital_product" id="send_digital_product_no" {{ app('general_setting')->send_digital_product == 0 ? 'checked':'' }} value="0" class="de_active status" type="radio">
                                        <span class="checkmark"></span>
                                    </label>
                                    <p>{{ __('common.no') }}</p>
                                </li>
            ...
            <div class="form-card">
                <h3>{{ __('general_settings.text_content_settings') }}</h3>
                <div class="row">
                    ...
                    <div class="col-xl-6 mt-1">
                        <div class="primary_input">
                            ...
                            <input class="primary_input_field" placeholder="-" type="text" id="max_digit"    name="max_digit" value="{{ app('general_setting')->max_digit }}" >
                        </div>
                    </div>
            ...
            <div class="form-card">
                <div class="mb-3">
                    <h3 class="mb-1">{{ __('general_settings.invoice_footer_settings') }}</h3>
                    <p class="text-muted mb-0">{{ __('general_settings.invoice_footer_settings_hint') }}</p>
                </div>
                <div class="row">
                    @php
                        $locale = app()->getLocale();
                        $footerText  = json_decode($setting->invoice_footer_text, true)  ?? [];
                        $footerQuote = json_decode($setting->invoice_footer_quote, true) ?? [];
                    @endphp

                    <div class="col-xl-6 mt-1">
                        <div class="primary_input">
                            <label class="primary_input_label" for="invoice_footer_text">
                                {{ __('general_settings.invoice_footer_text') }}
                            </label>
                            <textarea class="primary_input_field form-control" cols="15" rows="5" id="invoice_footer_text" name="invoice_footer_text">{{ $footerText[$locale] ?? ($footerText['es'] ?? '') }}</textarea>
                        </div>
                    </div>

                    <div class="col-xl-6 mt-1">
                        <div class="primary_input">
                            <label class="primary_input_label" for="invoice_footer_quote">
                                {{ __('general_settings.invoice_footer_quote') }}
                            </label>
                            <textarea class="primary_input_field form-control" cols="15" rows="5" id="invoice_footer_quote" name="invoice_footer_quote">{{ $footerQuote[$locale] ?? ($footerQuote['es'] ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            @if (permissionCheck('company_information_update'))
                <div class="submit_btn text-center mt-4">
                    <button class="btn-toolkit btn-primary btn-icon" type="submit"> <i class="ti-check"></i> {{ __('common.save') }}</button>
                </div>
            @endif
        </div>
    </div>

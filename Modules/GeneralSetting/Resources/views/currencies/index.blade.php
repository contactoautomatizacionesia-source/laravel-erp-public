            ...
            <div class="col-12">
                <div class="box_header common_table_header">
                    <div class="main-title d-flex">
                        ...
                        <ul class="d-flex">
                            <li><a data-toggle="modal" class="primary-btn radius_30px mr-10 fix-gr-bg currency_modal_open"><i class="ti-plus"></i>{{ __('general_settings.add_new_currency') }}</a></li>
                        </ul>
                        @endif
                    </div>
                </div>
                            ...
                            <table class="table Crm_table_active3">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('general_settings.convert_rate') }} {{ getNumberTranslate(1) }} {{app('general_setting')->currency_code}} = ?</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ getNumberTranslate($currency->convert_rate) }} {{ $currency->symbol }}</td>
                                        <td>
                                            <!-- shortby  -->
                            ...
                            <div class="col-xl-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="">{{ __('general_settings.convert_rate') }}
                                        {{ getNumberTranslate(1) }} {{app('general_setting')->currency_code}} = ? <span class="text-danger">*</span></label>
            ...
            $(document).on('click','.update-status', function(){
                ...
                $.post('{{ route('currencies.update_active_status') }}', {_token:'{{ csrf_token() }}', id:this.value, status:status}, function(data){
                    ...
                    if(data.msg === 'success'){
                        ...
                        toastr.error("{{__('general_settings.default_currency_not_changeble')}}","{{__('common.error')}}");
                        $('#pre-loader').addClass('d-none');
                    }
                    else{

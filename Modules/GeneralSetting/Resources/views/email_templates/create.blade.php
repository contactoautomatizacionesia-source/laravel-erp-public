                                        ...
                                        <select class="primary_select mb-25" name="type_id" id="type_id">
                                            @foreach ($email_template_types as $key => $type)
                                                @if(!$type->module or isModuleActive($type->module))
                                                    {{-- Usamos la llave dinámica de traducción --}}
    ...
    <script type="text/javascript">
        (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('keydown', '.nice-select .nice-select-search', function(e) {
                    if (e.key === ' ' || e.keyCode === 32) {
                        e.stopPropagation(); // Evita que el evento suba al contenedor principal
                    }
                });                
                $(document).on('keydown', '.nice-select input', function(e) {
                    if (e.key === ' ' || e.keyCode === 32) {
                        e.stopPropagation(); 
                    }
                });
                ...
                $('form').on('submit', function() {
                    // Mostramos el preloader justo antes de que el formulario se envíe

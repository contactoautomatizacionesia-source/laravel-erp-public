                    ...
                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label" for="event">{{ __('hr.event') }}<span class="text-danger">*</span></label>
                                                        <input class="primary_input_field" type="text" id="event_{{$language->code}}" class="form-control" placeholder="{{__('hr.event')}}" name="event[{{$language->code}}]" autocomplete="off" value="">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <textarea name="message[{{$language->code}}]" id="message_{{$language->code}}" cols="30" class="form-control primary_input_field" placeholder="{{__('common.message')}}" rows="5"></textarea>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <textarea name="admin_msg[{{$language->code}}]" id="admin_msg_{{$language->code}}" cols="30" class="form-control primary_input_field" placeholder="{{__('common.message')}}" rows="5"></textarea>
                        ...
                        @else
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="event">{{ __('hr.event') }} <span class="text-danger">*</span></label>
                                    <input class="primary_input_field" type="text" id="event" class="form-control" name="event" placeholder="{{__('hr.event')}}" autocomplete="off" value="" required>
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="message"> {{__('general_settings.message_for_particular_user')}} <span class="text-danger">*</span></label>
                                    <textarea name="message" id="message" cols="30" class="form-control primary_input_field" placeholder="{{__('common.message')}}" rows="5" required></textarea>
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="message">{{__('general_settings.message_for_admin_site')}} <span class="text-danger">*</span></label>
                                    <textarea name="admin_msg" id="admin_msg" cols="30" class="form-control primary_input_field" placeholder="{{__('common.message')}}" rows="5" required></textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label" for="type">{{ __('hr.event') }} {{ __('common.type') }}<span class="text-danger">*</span></label>

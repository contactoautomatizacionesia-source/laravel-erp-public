...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor ign-general-setting">
    ...
    <script type="text/javascript">
        (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('change', '#site_logo_light', function(event){
                    imageChangeWithFile($(this)[0],'#generalSettingLogoLight');
                });
                ...
                $(document).on('change', '#lazyload_image', function(event){
                    imageChangeWithFile($(this)[0],'#generalSettingLazyloadImage');
                });
                $(document).on('change', '#bg_footer', function(event){
                    imageChangeWithFile($(this)[0],'#generalSettingBgFooter');
                });

...
class NotificationSettingController extends Controller
{
    ...
    public function update(UpdateNotificationSettingRequest $request)
    {
        try {
            ...
            LogActivity::errorLog($e->getMessage());
            return response()->json(['error' => $e->getMessage()], HttpStatusCode::UNPROCESSABLE_ENTITY->value);
        } catch (Exception $e) {
            LogActivity::errorLog($e->getMessage());
            return response()->json(['error' => __('common.Something Went Wrong')], HttpStatusCode::INTERNAL_SERVER_ERROR->value);
        }
    }

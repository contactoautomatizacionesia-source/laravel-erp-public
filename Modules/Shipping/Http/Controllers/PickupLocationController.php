...
class PickupLocationController extends Controller
{
    ...
    public function status(Request $request)
    {
        ...
        } catch (CannotActivatePickupLocationException $e) {
            return response()->json(['error' => $e->getMessage()], 422);
        } catch (\Exception $e) {
            LogActivity::errorLog($e->getMessage());
            return response()->json(['error' => __('common.Something Went Wrong')], 503);
        }
    }
    ...
    {
        try{
            $res = $this->pickupLocationRepo->setPickupLocation($id); //NOSONAR

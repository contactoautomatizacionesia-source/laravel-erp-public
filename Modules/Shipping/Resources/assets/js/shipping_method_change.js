(function($) {
    ...
    $(document).ready(function(){
        ...
        $(document).on('submit', '#shipping_method_change', function(event){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    $('#pre-loader').addClass('d-none');
                    location.reload();
                    toastr.success('Método de envío cambiado exitosamente');
                },
        ...
        $(document).on('click', '#shipping_method_changes', function(event){
            ...
            {
                $('#pre-loader').addClass('d-none');
                toastr.warning("Por favor seleccione un pedido.");
            }  else {
        ...
        $(document).on('submit', '#multiple_shipping_method_change', function(event){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    $('#pre-loader').addClass('d-none');
                    location.reload();
                    toastr.success('Método de envío actualizado exitosamente');
                },
                error:function(response) {
                    $('#pre-loader').addClass('d-none');

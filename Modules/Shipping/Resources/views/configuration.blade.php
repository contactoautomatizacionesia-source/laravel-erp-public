                                    ...
                                    <div class="row">
                                                ...
                                                <ul class="permission_list sms_list">
                                                    <li>
                                                        <label class="primary_checkbox d-flex mr-12 ">
                                                            <input name="order_confirm_and_sync" class="order_confirm_and_sync" type="radio"  value="Automatic" {{@$row->order_confirm_and_sync == 'Automatic'? 'Checked' :''}}>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <span class="text-black">{{__('shipping.automatic')}}</span>
                                                    </li>
                                                    <li>
                                                        <label class="primary_checkbox d-flex mr-12 ">
                                                            <input name="order_confirm_and_sync" class="order_confirm_and_sync" type="radio"  value="Manual" {{@$row->order_confirm_and_sync == 'Manual'? 'Checked' :''}}>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <span class="text-black">{{__('shipping.manual')}}</span>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <ul class="permission_list sms_list">
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="carrier_show_for_customer" class="carrier_show_for_customer" type="radio"  value="1" {{@$row->carrier_show_for_customer == 1? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.yes')}}</span>
                                                </li>
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="carrier_show_for_customer" class="carrier_show_for_customer" type="radio"  value="0" {{@$row->carrier_show_for_customer == 0? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.no')}}</span>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <ul class="permission_list sms_list">
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="carrier_order_type" class="carrier_order_type" type="radio"  value="Custom" {{@$row->carrier_order_type == 'Custom'? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.Custom')}}</span>
                                                </li>
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="carrier_order_type" class="carrier_order_type" type="radio"  value="Quick" {{@$row->carrier_order_type == 'Quick'? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.Quick')}}</span>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <ul class="permission_list sms_list">
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="refund_order_sync_carrier" class="refund_order_sync_carrier" type="radio"  value="1" {{@$row->refund_order_sync_carrier == 1? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.yes')}}</span>
                                                </li>
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="refund_order_sync_carrier" class="refund_order_sync_carrier" type="radio"  value="0" {{@$row->refund_order_sync_carrier == 0? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.no')}}</span>
                                                </li>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <ul class="permission_list sms_list">
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="label_code" class="label_code" type="radio"  value="barcode" {{@$row->label_code == 'barcode'? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.barcode')}}</span>
                                                </li>
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="label_code" class="label_code" type="radio"  value="qrcode" {{@$row->label_code == 'qrcode'? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.qrcode')}}</span>
                                                </li>
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="label_code" class="label_code" type="radio"  value="both" {{@$row->label_code == 'both'? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.both')}}</span>
                                                </li>
                                            </ul>
                                        ...
                                        @if(isModuleActive('ShipRocket') && auth()->user()->role->type =="superadmin")
                                            <div class="col-lg-3">
                                                ...
                                                <ul class="permission_list sms_list">
                                                    <li>
                                                        <label class="primary_checkbox d-flex mr-12 ">
                                                            <input name="seller_use_shiproket" class="seller_use_shiproket" type="radio"  value="1" {{@$row->seller_use_shiproket == 1? 'Checked' :''}}>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <span class="text-black">{{__('shipping.yes')}}</span>
                                                    </li>
                                                    <li>
                                                        <label class="primary_checkbox d-flex mr-12 ">
                                                            <input name="seller_use_shiproket" class="seller_use_shiproket" type="radio"  value="0" {{@$row->seller_use_shiproket == 0? 'Checked' :''}}>
                                                            <span class="checkmark"></span>
                                                        </label>
                                                        <span class="text-black">{{__('shipping.no')}}</span>
                                                    </li>
                                        ...
                                        <div class="col-lg-3">
                                            <label class="primary_input_label" for="shipping_amount_back_refund_complete_active">{{__('shipping.shipping_amount_back_refund_complete')}} <span class="required_mark_theme">*</span></label>
                                            <ul class="permission_list sms_list">
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="shipping_amount_back_refund_complete" class="shipping_amount_back_refund_complete" type="radio" id="shipping_amount_back_refund_complete_active" value="1" {{@$row->shipping_amount_back_refund_complete == 1? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.yes')}}</span>
                                                </li>
                                                <li>
                                                    <label class="primary_checkbox d-flex mr-12 ">
                                                        <input name="shipping_amount_back_refund_complete" class="shipping_amount_back_refund_complete" type="radio" id="shipping_amount_back_refund_complete_inactive" value="0" {{@$row->shipping_amount_back_refund_complete == 0? 'Checked' :''}}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                    <span class="text-black">{{__('shipping.no')}}</span>
                                                </li>
                                            </ul>
                                            <span class="text-danger">{{$errors->first('shipping_amount_back_refund_complete')}}</span>
                                        </div>

                                    </div>
                                    <div class="row">

                                        <div class="col-xl-12 mt-repeater no-extra-space main-title">
                                            <h3>{{__('shipping.label_terms_and_conditions')}}</h3>
                                            ...
                                            <div class="col-md-offset-1 col-md-9">
                                                <a href="javascript:;" data-repeater-create  class="btn-toolkit btn-secondary-outline btn-icon mt-repeater-add"><i class="fa fa-plus"></i>{{__('shipping.add_more')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-10">

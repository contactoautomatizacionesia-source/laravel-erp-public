    ...
    <div class="white_box p-15 box_shadow_white mb-20">
        <div class="row">
                ...
                <ul class="permission_list sms_list">
                    <li>
                        <label class="primary_checkbox d-flex mr-12 ">
                            <input name="cost_based_on" class="cost_based_on" type="radio"  value="Price">
                            <span class="checkmark"></span>
                            <span class="text-black ml-2">{{ __('shipping.price') }}</span>
                        </label>
                    </li>
                    <li>
                        <label class="primary_checkbox d-flex mr-12 ">
                            <input name="cost_based_on" class="cost_based_on" type="radio"  value="Weight">
                            <span class="checkmark"></span>
                            <span class="text-black ml-2">{{ __('shipping.weight') }}</span>
                        </label>
                    </li>
                    <li>
                        <label class="primary_checkbox d-flex mr-12 ">
                            <input checked name="cost_based_on" class="cost_based_on" type="radio"  value="Flat">
                            <span class="checkmark"></span>
                            <span class="text-black ml-2">{{ __('shipping.flat') }}</span>
                        </label>
                    </li>
                </ul>
            ...
            <div class="col-lg-12 text-center">
                <button class="btn-toolkit btn-primary btn-icon"><i class="ti-check"></i>{{__("common.save")}} </button>
            </div>
        </div>
    </div>
</form>

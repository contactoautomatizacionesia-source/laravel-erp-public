...
class ProductTest extends TestCase
{
    ...
    public function test_for_add_excisting_single_product()
    {
        ...
        SellerBusinessInformation::updateOrCreate(['user_id' => 4], [
            'business_owner_name' => 'Test Owner',
            'business_address1' => 'Test Address',
            'business_country' => '1',
            'business_state' => '1',
            'business_city' => '1',
        ]);
        SellerBankAccount::updateOrCreate(['user_id' => 4], [
        ...
        $this->post('/seller/product-store',[
            "product_id" => $product->id,
            "stock_manage" => "1",
            "product_stock" => 5,
            "purchase_price" => 6000,
            ...
            'subtitle_1' => null,
            'subtitle_2' => null,
            'wholesale_min_qty_0' => [null],
            'wholesale_max_qty_0' => [null],
            'wholesale_price_0' => [null],
    ...
    public function test_for_add_excisting_variant_product()
    {
        ...
        $this->post('/seller/product-store',[
            ...
            'subtitle_1' => null,
            'subtitle_2' => null,
            'wholesale_min_qty_v_0' => [null],
            'wholesale_max_qty_v_0' => [null],
            'wholesale_price_v_0' => [null],
            'wholesale_min_qty_v_1' => [null],
            'wholesale_max_qty_v_1' => [null],
            'wholesale_price_v_1' => [null],
    ...
    public function test_for_create_single_my_product()
    {
        ...
        $this->post('/products/store',[
            ...
            'request_from' => 'seller_product_form',
            'galary_image' => [],
    ...
    {
        $this->markTestSkipped('View rendering error in my_product_edit.blade.php with gst_config binding.');

...
@section('styles')
<link rel="stylesheet" href="{{asset(asset_path('modules/seller/css/support_ticket_edit.css'))}}" />
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                <div class="white_box_30px box_shadow_white">
                    <!-- Prefix  -->
                    <form class="form-horizontal" action="{{ route('seller.support-ticket.update',$editData->id) }}"
                                ...
                                <div class="attach-file-section">
                                    ...
                                    <div class="row ml-0">
                                        ...
                                        <div class="col-10 attach_data">
                                            <a class="attach_file_name" href="{{ URL::to('/') }}/{{ $file->url }}"
                                                download="">{{  $key+1 }} .

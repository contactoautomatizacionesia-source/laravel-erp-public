                            ...
                            <form action="{{route('seller.product.store')}}" method="POST"
                                    ...
                                    <div id="single_product_stock_manage_div" class="col-xl-6">
                                        <div class="primary_input mb-25">
                                            ...
                                            <select class="primary_select mb-25" name="stock_manage" id="stock_manage"
                                                required>
                                                <option value="1" selected>{{ __('common.yes') }}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field" name="selling_price" id="selling_prices"
                                                placeholder="{{__("product.selling_price")}}" type="number" min="1"
                                                step="{{step_decimal()}}" value="" required>
                                            @error('selling_price')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                                   ...
                                                   <div class="row">
                                                       ...
                                                       <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" name="subtitle_1[{{$language->code}}]" id="subtitle_1_{{$language->code}}" placeholder="{{ __('product.subtitle_1') }}" type="text" value="{{old('subtitle_1.'.$language->code)}}">
                                                    ...
                                                    <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" name="subtitle_2[{{$language->code}}]" id="subtitle_2_{{$language->code}}" placeholder="{{ __('product.subtitle_2') }}" type="text" value="{{old('subtitle_2.'.$language->code)}}">
                                ...
                                @endif
                                    <div class="col-lg-6">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                for="">{{ __('product.thumbnail_image') }} ({{getNumberTranslate(165)}} x {{getNumberTranslate(165)}}) {{__('common.px')}}</label>
                                                        ...
                                                        @foreach ($LanguageList as $key => $language)
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="primary_input mb-15">
                                                                        <label class="primary_input_label" for="product_name"> {{ __('common.name') }} <span class="text-danger">*</span></label>
                                                                        <input class="primary_input_field" name="product_name[{{$language->code}}]" id="product_name_new_{{$language->code}}" placeholder="{{ __('common.name') }}" type="text" value="{{old('product_name.'.$language->code)}}">
                                                                ...
                                                                <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                                    <div class="primary_input mb-15">
                                                                        <label class="primary_input_label" for="subtitle_1"> {{ __('product.subtitle_1') }}</label>
                                                                        <input class="primary_input_field" name="subtitle_1[{{$language->code}}]" id="subtitle_1" placeholder="{{ __('product.subtitle_1') }}" type="text" value="{{old('subtitle_1.'.$language->code)}}">
                                                                        <span id="error_subtitle_1" class="text-danger">{{ $errors->first('subtitle_1') }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                                                    <div class="primary_input mb-15">
                                                                        <label class="primary_input_label" for="subtitle_2"> {{ __('product.subtitle_2') }}</label>
                                                                        <input class="primary_input_field" name="subtitle_2[{{$language->code}}]" id="subtitle_2" placeholder="{{ __('product.subtitle_2') }}" type="text" value="{{old('subtitle_2.'.$language->code)}}">
                                                                        <span id="error_subtitle_2" class="text-danger">{{ $errors->first('subtitle_2') }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-lg-3 d-none variant_sku_prefix">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <input class="primary_input_field" name="club_point" id="club_point" placeholder="{{__('clubpoint.point') }}" type="number" min="0" value="{{old('club_point')?old('club_point'):0}}">
                                                        <span class="text-danger" id="error_discunt">{{ $errors->first('club_point')}}</span>
                                                    </div>
                                                </div>
                                                @endif
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <select class="primary_select mb-25" name="tax_id" id="tax_id">
                                                            ...
                                                            @foreach($gst_lists as $gst)
                                                                <option value="{{$gst->id}}" @if(old('tax_id') && old('tax_id') == $gst->id) selected @endif>{{ $gst->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="tab-content">
                                                        @foreach ($LanguageList as $key => $language)
                                                            <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="pelement{{$language->code}}">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="primary_input mb-15">
                                                                        <textarea class="summernote" name="description[{{$language->code}}]"> {{old('description.'.$language->code)}} </textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <div class="main-title d-flex">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="primary_input mb-15">
                                                                        <textarea class="summernote" id="specification" name="specification[{{$language->code}}]"> {{old('specification.'.$language->code)}} </textarea>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="primary_input mb-15">
                                                                        ...
                                                                        <input class="primary_input_field" id="meta_title" name="meta_title[{{$language->code}}]" placeholder="{{ __('common.meta_title') }}" type="text" value="{{old('meta_title.'.$language->code)}}">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="primary_input mb-15">
                                                                        ...
                                                                        <textarea class="primary_textarea height_112 meta_description" id="meta_description" placeholder="{{ __('common.meta_description') }}" name="meta_description[{{$language->code}}]" spellcheck="false">{{old('meta_description.'.$language->code)}}</textarea>
...
<script type="text/javascript">
    (function($){
            ...
            function productTypeChange(val){
                if(val == 2){
                    ...
                    if("{{ auth()->user()->role->type }}" == "superadmin" || "{{ auth()->user()->role->type }}" == "admin" || "{{ auth()->user()->role->type }}" == "staff"){
                        location.href = "{{ route('product.create',['add_type' => 'in-house']) }}";
                    }else{
        ...
        function isStockManage()
        {

            let isManaged = $("#stock_manage").val();
            console.log(isManaged);
            if(isManaged == 1)
            {
                $("#single_stock_div").removeClass('d-none');

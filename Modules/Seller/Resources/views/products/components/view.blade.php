                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-nowrap">
                                                                ...
                                                                @if(isModuleActive('WholeSale'))
                                                                    @php
                                                                        if ($sku){
                                                                            $wholesalePrices = $sku->wholeSalePrices;
                                                                        }
                                                                    @endphp
                                                                    @if(!empty($wholesalePrices))
                                                                        <br><span> {{__('wholesale.Wholesale Price')}}: </span>
                                                                        <ul>
                                                                            @foreach($wholesalePrices as $w_price)
                                                                                <li> <span>{{__('wholesale.Range')}}: ({{ $w_price->min_qty.'-'.$w_price->max_qty }}) </span>  {{ single_price($w_price->selling_price) }}</li>
                                                                            @endforeach
                                                                        </ul>
                                                                    @endif
                                                                @endif
                                                            ...
                                                            <td>
                                                                <label class="switch_toggle" for="checkbox{{ $sku->id }}">
                                                                    <input type="checkbox" class="sku_status_change" id="checkbox{{ $sku->id }}" @if ($sku->status == 1) checked @endif value="{{ $sku->id }}">

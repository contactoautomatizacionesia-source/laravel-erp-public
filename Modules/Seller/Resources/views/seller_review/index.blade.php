...
<link rel="stylesheet" href="{{asset(asset_path('modules/seller/css/seller_review.css'))}}" />


@endsection
@section('mainContent')
<section class="admin-visitor-area up_st_admin_visitor ign-seller-my-reviews">

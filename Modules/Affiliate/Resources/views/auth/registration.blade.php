...
@endsection
@section('content')
    <section class="register_part bg-custom-login">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="register_form_iner">
                        ...
                        <form method="POST" action="{{ route('affiliate.register') }}" class="register_form" name="register" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    @foreach($form_data as $row)
                                        @php
                                            if($row->type != 'header' && $row->type !='paragraph'){
                                                ...
                                                $placeholder = property_exists($row,'placeholder') ? $row->placeholder : '';
                                            }
                                        @endphp

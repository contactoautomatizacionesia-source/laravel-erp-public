...
@section('mainContent')
    <section class="admin-visitor-area up_st_admin_visitor ign-pending-withdraw">
            ...
            <div class="row">
                <div class="col-md-3 date-range-block">
                    <div class="primary_input mb-15 date_range">
                        <div class="primary_datepicker_input filter">
                            <label class="primary_input_label" for="">{{__('affiliate.select_date_range')}}</label>
                ...
                <div class="col-lg-4 mt-30">
                    <div class="d-flex">
                        ...
                        <a type="button" href="{{route('affiliate.pending_withdraw')}}" class="primary-btn  fix-gr-bg">{{__('common.reset')}}</a>
                    </div>
                </div>
            </div>

                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-12">
                                <ul class="nav nav-tabs justify-content-start mt-sm-md-20 mb-30 grid_gap_5">
                                    @foreach ($LanguageList as $key => $language)
                                        <li class="nav-item">
                                            <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif" href="#emacelement{{$language->code}}" role="tab" data-toggle="tab">{{ $language->native }} </a>
                                        </li>
                                    @endforeach
                                </ul>
                        ...
                        @else
                            <div class="col-md-12">
                                <div class="primary_input mb-25">
                                <label class="primary_input_label" for="name">{{__('frontendCms.page_name')}}<span class="text-danger">*</span></label>
                                    <input class="primary_input_field " type="text" name="name" id="widget_name" autocomplete="off">
                                </div>
                                @error('name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-lg-12 text-center mt-10">
                            ...
                            <button type="submit" class="btn-toolkit btn-primary btn-icon " data-original-title="" title="">

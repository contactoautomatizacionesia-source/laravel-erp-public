                            ...
                            <div class="tab-content">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <ul class="nav nav-tabs justify-content-start mt-sm-md-20 mb-30 grid_gap_5" >
                                                                    @foreach ($LanguageList as $key => $language)
                                                                        <li class="nav-item">
                                                                            <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif" href="#element{{$language->code}}" role="tab" data-toggle="tab" >{{ $language->native }} </a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                                <div class="tab-content">
                                            ...
                                            <div class="white-box">
                                                <div class="add-visitor">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="primary_input mb-25">
                                                                <label class="mb-2 mr-30" for="placeholderFileOneName">{{ __('common.image') }}<small>({{getNumberTranslate(513)}} X {{getNumberTranslate(60)}}){{__('common.px')}}</small></label>
                                    ...
                                    <div class="row">
                                                ...
                                                <form method="POST" id="aboutForm" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                                    ...
                                                    <div class="white-box">
                                                        <div class="add-visitor">
                                                            ...
                                                            @if(isModuleActive('FrontendMultiLang'))
                                                                <div class="col-lg-12">
                                                                    <ul class="nav nav-tabs justify-content-start mt-sm-md-20 ml-0 mb-30" >
                                                                        @foreach ($LanguageList as $key => $language)
                                                                            <li class="nav-item">
                                                                                <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif" href="#atelement{{$language->code}}" role="tab" data-toggle="tab">{{ $language->native }} </a>
                                                                            </li>
                                                                        @endforeach
                                                                    </ul>
                                                                    <div class="tab-content">
                                                                        @foreach ($LanguageList as $key => $language)
                                                                            <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="atelement{{$language->code}}">
                                                                                <div class="primary_input mb-25">
                                                                                    ...
                                                                                    <input name="about_title[{{$language->code}}]" id="about_title[{{$language->code}}]" class="primary_input_field" placeholder="-" type="text" value="{{isset($FooterContent)?$FooterContent->getTranslation('footer_about_title',$language->code):old('about_title.'.$language->code)}}">
                                                                                    <span class="text-danger"  id="error_about_title[{{$language->code}}]"></span>
                                                                                </div>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                        ...
                                        <div class="col-lg-9 mt-50">
                                            <form method="POST" action="" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data" id="aboutDescriptionForm">
                                                <input type="hidden" name="id" value="{{$FooterContent->id}}">
                                                <div class="white-box">
                                                 <div class="row justify-content-center mb-30 mt-10">
                                                    @if(isModuleActive('FrontendMultiLang'))
                                                        <div class="col-lg-12">
                                                            <ul class="nav nav-tabs justify-content-start mt-sm-md-20 mb-30 grid_gap_5" >
                                                                @foreach ($LanguageList as $key => $language)
                                                                    <li class="nav-item">
                                                                        <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif" href="#adelement{{$language->code}}" role="tab" data-toggle="tab" >{{ $language->native }} </a>
                                                                    </li>
                                                                @endforeach
                                                            </ul>
                                                            <div class="tab-content">
                                                                @foreach ($LanguageList as $key => $language)
                                                                    <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="adelement{{$language->code}}">
                                                                        <div class="primary_input mb-25">
                                                                            ...
                                                                            <textarea class="summernote lms_summernote" name="about_description[{{$language->code}}]" id="about_description[{{$language->code}}]">{{isset($FooterContent)?$FooterContent->getTranslation('footer_about_description',$language->code):old('about_description.'.$language->code)}}</textarea>
                                                                            <span class="text-danger"  id="error_about_description[{{$language->code}}]"></span>
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane {{ $footerTab == 3?'active show':'' }} fade" id="footer_2">
                                    <div class="row">
                                                    ...
                                                    <div class="white-box">
                                                        <div class="add-visitor">
                                                            <div class="row">
                                                                @if(isModuleActive('FrontendMultiLang'))
                                                                    <div class="col-lg-12">
                                                                        <ul class="nav nav-tabs justify-content-start mt-sm-md-20 mb-30 ml-0" >
                                                                            @foreach ($LanguageList as $key => $language)
                                                                                <li class="nav-item">
                                                                                    <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif" href="#maselement{{$language->code}}" role="tab" data-toggle="tab" >{{ $language->native }} </a>
                                                                                </li>
                                                                            @endforeach
                                                                        </ul>
                                                                        <div class="tab-content">
                                                                            @foreach ($LanguageList as $key => $language)
                                                                                <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="maselement{{$language->code}}">
                                                                                    <div class="primary_input mb-25">
                                                                                        ...
                                                                                        <input name="company_title[{{$language->code}}]" id="company_title[{{$language->code}}]" class="primary_input_field" placeholder="-" type="text" value="{{isset($FooterContent)?$FooterContent->getTranslation('footer_section_one_title',$language->code):old('company_title.'.$language->code)}}">
                                                                                        <span class="text-danger"  id="error_company_title[{{$language->code}}]"></span>
                                                                                    </div>
                                                                                </div>
                                                                            @endforeach
                                                                        </div>
                                        ...
                                        <div class="col-lg-9 mt-50">
                                            @if (permissionCheck('footerSetting.footer.widget-store'))
                                                <a href="" data-id="1" id="add_new_page_btn" class="primary-btn small bg-color-base create_page_btn">{{__('frontendCms.add_new_page')}}</a>
                                            @endif
                                ...
                                <div role="tabpanel" class="tab-pane {{ $footerTab == 4?'active show':'' }} fade" id="footer_3">
                                    <div class="row">
                                                            ...
                                                            @if(isModuleActive('FrontendMultiLang'))
                                                                <div class="col-lg-12">
                                                                    <ul class="nav nav-tabs justify-content-start mt-sm-md-20 ml-0 mb-30" >
                                                                        @foreach ($LanguageList as $key => $language)
                                                                            <li class="nav-item">
                                                                                <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif" href="#cstelement{{$language->code}}" role="tab" data-toggle="tab" >{{ $language->native }} </a>
                                                                            </li>
                                                                        @endforeach
                                                                    </ul>
                                                                    <div class="tab-content">
                                                                        @foreach ($LanguageList as $key => $language)
                                                                            <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="cstelement{{$language->code}}">
                                                                                ...
                                                                                <span class="text-danger"  id="error_account_title[{{$language->code}}]"></span>
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="col-lg-9 mt-50">
                                            @if (permissionCheck('footerSetting.footer.widget-store'))
                                                <a data-id="2" class="primary-btn small bg-color-base create_page_btn">{{__('frontendCms.add_new_page')}}</a>
                                            @endif
                                                        ...
                                                        <tbody>
                                                            @foreach($SectionTwoPages as $key => $page)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <label class="switch_toggle" for="checkbox{{ $page->id }}">
                                                                            <input type="checkbox" {{$page->status?'checked':''}} value="{{$page->id}}" data-value="{{$page}}" class="statusChange">
                                                                            <div class="slider round"></div>
                                                                        </label>
                                                                    </td>
                                                                    <td>
                                ...
                                <div role="tabpanel" class="tab-pane {{ $footerTab == 5?'active show':'' }} fade" id="footer_4">
                                    <div class="row">
                                                                ...
                                                                @if(isModuleActive('FrontendMultiLang'))
                                                                    <div class="col-lg-12">
                                                                        <ul class="nav nav-tabs justify-content-start mt-sm-md-20 ml-0 mb-30" >
                                                                            @foreach ($LanguageList as $key => $language)
                                                                                <li class="nav-item">
                                                                                    <a class="nav-link anchore_color @if (auth()->user()->lang_code == $language->code) active @endif" href="#sstelement{{$language->code}}" role="tab" data-toggle="tab" >{{ $language->native }} </a>
                                                                                </li>
                                                                            @endforeach
                                                                        </ul>
                                                                        <div class="tab-content">
                                                                            @foreach ($LanguageList as $key => $language)
                                                                                <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="sstelement{{$language->code}}">
                                                                                    ...
                                                                                    <span class="text-danger"  id="error_service_title[{{$language->code}}]"></span>
                                                                                </div>
                                                                            @endforeach
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="col-lg-9 mt-50">
                                            @if(permissionCheck('footerSetting.footer.widget-store'))
                                                <a href="" data-id="3" class="primary-btn small bg-color-base create_page_btn">{{__('frontendCms.add_new_page')}}</a>
                                            @endif
                                            <div class="QA_section QA_section_heading_custom check_box_table">
                                                <div class="QA_table">
                                                    <table class="table Crm_table_active3">

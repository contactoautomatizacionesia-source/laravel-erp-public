    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            @if(isModuleActive('FrontendMultiLang'))
                <div class="row">
                    <div class="col-lg-12">
                        <a class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{ route('form_builder.builder.translation') }}">
                            {{ __("formBuilder.translation") }}
                        </a>
                    </div>
                </div>
            @endif
                                        ...
                                        <tbody>
                                            @foreach($forms as $row)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$row->name}}</td>
                                                    <td> <a target="_blank" href="{{route('form_builder.forms.show',$row->id)}}" class="btn-toolkit btn-ghost btn-icon">{{ __('common.view') }}<i class="ti-arrow-top-right"></i></a></td>
                                                    <td>

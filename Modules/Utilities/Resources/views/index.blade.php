...
<div class="row justify-content-center">
    ...
    <div class="col-lg-12">
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3 col-sm-6 mb-2 d-flex">
                <a class="white-box  d-block btn-ajax w-100" href="{{ route('utilities.index', ['utilities' => 'optimize_clear']) }}">
            ...
            <div class="col-md-4 col-lg-3 col-sm-6 mb-2 d-flex">
                <a class="white-box  d-block btn-ajax w-100"
            ...
            @if(auth()->id() == 1)
            <div class="col-md-4 col-lg-3 col-sm-6 mb-2 d-flex">
                <a class="white-box  d-block btn-ajax w-100" id="reset_database_card" href="#">
                    <div class="d-block mt-10 text-center ">
            ...
            @if(auth()->id() == 1)
                <div class="col-md-4 col-lg-3 col-sm-6 mb-2 d-flex">
                    <a class="white-box  d-block btn-ajax w-100" id="import_database_card" href="#">
                        <div class="d-block mt-10 text-center ">
                            <h3><i class="fas fa-database font_30"></i></h3>
            ...
            <div class="col-md-4 col-lg-3 col-sm-6 mb-2 d-flex">
                <a class="white-box  d-block btn-ajax w-100" href="#" id="xml_sitemap_card">
                    <div class="d-block mt-10 text-center ">
            ...
            <div class="col-md-4 col-lg-3 col-sm-6 mb-2 d-flex">
                <a class="white-box  d-block btn-ajax w-100" id="remove_visitor_card" href="#">
                    <div class="d-block mt-10 text-center ">
            ...
            <div class="col-md-4 col-lg-3 col-sm-6 mb-2 d-flex">
                <a class="white-box  d-block btn-ajax w-100" id="convertImageModel" href="#">
                    <div class="d-block mt-10 text-center ">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mt-10 justify-content-between">

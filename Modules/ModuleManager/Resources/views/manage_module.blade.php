                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="display school-table school-table-style" cellspacing="0" width="100%">
                                ...
                                @foreach($is_module_available as $row)
                                    ...
                                    @endphp
                                    <tr>
                                        <td>{{ getNumberTranslate(@$count++)}}</td>
                                        <td>
                                            ...
                                            @includeIf('service::license.revoke-module', ['name' =>$row->name, 'row' => false, 'file' =>false])
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 ">
                                                        <a class="primary-btn fix-gr-bg text-nowrap" target="_blank"
                                                           href="https://aorasoft.com/">   {{__('general_settings.buy_now')}}</a>

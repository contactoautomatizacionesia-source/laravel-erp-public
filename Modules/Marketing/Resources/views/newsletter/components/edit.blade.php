        ...
        <div class="">
            <div class="col-lg-10 offset-lg-1">
                <div class="main-title">
                    <h3 class="mb-30">{{__('marketing.update_news_letter')}} </h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="add-visitor">
                        <div class="row">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="element{{$language->code}}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <textarea name="message[{{$language->code}}]" id="message" class="summernote" placeholder="" >{{isset($message)?$message->getTranslation('message',$language->code):old('message.'.$language->code)}}</textarea>
                            ...
                            <div id="subscriber_div" class="col-lg-12 {{$message->send_type == 4?'':'d-none'}}">
                                <label>{{__('marketing.mail_to')}} <span class="text-danger">*</span></label>
                                <br>
                                @php
                                ...
                                @foreach ($subscribers as $key => $subscriber)
                                    <div class="">
                                        <input type="checkbox" @if(in_array($subscriber->id,$emails)) checked @endif id="subscriber_{{ $key }}" class="common-checkbox subscriber_check" value="{{ $subscriber->id }}" name="subscriber_list[]">
                        ...
                        <div class="row mt-10">
                            <div class="col-lg-12 text-center">
                                ...
                                <button type="button" class="primary-btn fix-gr-bg" id="show_test_mail_btn" data-toggle="tooltip" title="" data-original-title=""> <span class="ti-check"></span>{{ __('marketing.test_mail') }} </button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        $(document).ready(function(){
            ...
            function showValidationErrors(formType, errors) {
                @if(isModuleActive('FrontendMultiLang'))
                    ...
                    $(formType + ' #error_message_{{auth()->user()->lang_code}}').text(errors['message.{{auth()->user()->lang_code}}']);
                @else

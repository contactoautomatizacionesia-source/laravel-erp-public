        ...
        <div class="">
            <div class="col-lg-10 offset-lg-1">
                <div class="main-title">
                    <h3 class="mb-30">{{__('marketing.create_news_letter')}} </h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="element{{$language->code}}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-25">
                                                        ...
                                                        <textarea name="message[{{$language->code}}]" id="message" class="summernote" placeholder="" >{{ old('message.'.$language->code) ?? $email_template->value }}</textarea>
                                                    </div>
                            ...
                            @else
                                <div class="col-lg-12">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="title">{{ __('common.title') }} <span class="text-danger">*</span></label>
                                        <input class="primary_input_field" type="text" id="title" name="title" autocomplete="off" value="" placeholder="{{ __('common.title') }}">
                                ...
                                <div class="primary_input mb-15">
                                    ...
                                    <div class="primary_datepicker_input">
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="">
                                                    <input placeholder="{{__('common.date')}}" class="primary_input_field primary-input date form-control" id="publish_date" type="text" name="publish_date" value="{{date('m/d/Y')}}" autocomplete="off" required>
                                                </div>
                                            </div>
                            ...
                            <div id="multiple_role_div" class="col-lg-12 d-none">
                                ...
                                @if(isModuleActive('MultiVendor'))
                                    @foreach ($roles as $key => $role)
                                        <div class="">
                                            <input type="checkbox" checked id="role_{{ $role->id }}" class="common-checkbox multi_check" value="{{ $role->id }}" name="role_list[]">
                            ...
                            <div id="subscriber_div" class="col-lg-12 d-none">
                                ...
                                <br>
                                <div class="">
                                    <input type="checkbox" checked id="subscriber_all" class="common-checkbox" value="" name="">
                        ...
                        <div class="row mt-10">
                            <div class="col-lg-6 offset-lg-3">
                                <div class="col-lg-12 text-center">
                                    <button id="submit_btn" type="submit" class="primary-btn fix-gr-bg" data-toggle="tooltip" title="" data-original-title=""> <span class="ti-check"></span>  {{ __('marketing.save_test_mail') }} </button>
                                </div>
                            </div>
                        </div>
                    </div>

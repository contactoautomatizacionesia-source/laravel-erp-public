                                            ...
                                            <tbody id="sku_tbody">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="product_info">
                                                            ...
                                                            <div class="product_name_div">
                                                                ...
                                                                <input type="hidden" name="product[]" value="{{!empty($product->product)  ? $product->product->id:$product->product_id}}">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    @if(isModuleActive('MultiVendor'))
                                                    <td class="text-center">
                                                        <div class="price_div">
                                                            <p class="text-nowrap">@if($product->product->seller->role->type == 'seller'){{ !empty($product->product->seller) ? $product->product->seller->first_name:'Inhouse'}} @else Inhouse @endif</p>
            ...
            <div role="tabpanel" class="tab-pane fade" id="priceSetup">
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="col-lg-12">
                            <div class="white-box box_shadow_white mb-40 minh-430">
                                <div class="row">
                                    @if(isModuleActive('FrontendMultiLang'))
                                        <div class="col-lg-12">
                                            <ul class="nav nav-tabs justify-content-start mt-sm-md-20 mb-30 grid_gap_5" role="tablist">
                                    ...
                                    <div id="categoryDiv" class="minh-250">
                                        @foreach($new_user_zone->categories as $key => $category)
                                            @if($category->category->status == 1)
                                                <div class="col-lg-12 p-0 single_item">
                                                    <div class="mb-10">
                                                        <div class="card" >

                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-30">{{__('marketing.update_flash_deal')}} </h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="row">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="element{{$language->code}}">
                                                            <div class="col-lg-12">
                                                                <div class="primary_input mb-25">
                                                                    ...
                                                                    <input class="primary_input_field" type="text" id="title" name="title[{{$language->code}}]" autocomplete="off" value="{{isset($flash_deal)?$flash_deal->getTranslation('title',$language->code):old('title.'.$language->code)}}" placeholder="{{ __('common.title') }}">
                                                                </div>
                                        ...
                                        @else
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for="title">{{__('common.title')}} <span class="text-danger">*</span></label>
                                                    <input class="primary_input_field" type="text" id="title" name="title" autocomplete="off" value="{{$flash_deal->title?$flash_deal->title:old('title')}}" placeholder="{{__('common.title')}}">
                                                    @error('title')
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" type="text" id="background_color" class="form-control" name="background_color" autocomplete="off" value="{{$flash_deal->background_color?$flash_deal->background_color:old('background_color')}}" placeholder="{{__('#000000')}}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input class="primary_input_field" type="text" id="text_color" name="text_color" autocomplete="off" value="{{$flash_deal->text_color?$flash_deal->text_color:old('text_color')}}" placeholder="{{__('#000000')}}">
                                                @error('text_color')
                                            ...
                                            <div class="primary_input mb-25">
                                                <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="false" data-type="image" data-name="flash_deal_banner_image">
                                                    ...
                                                    <button class="" type="button">
                                                        ...
                                                        <input type="hidden" class="selected_files" value="{{@$flash_deal->flash_deal_banner_image_media->media_id}}">
                                                    </button>
                                                </div>
                                                <div class="product_image_all_div">
                                                    @if(@$flash_deal->flash_deal_banner_image_media->media_id)
                                                        <input type="hidden" name="meta_image" class="product_images_hidden" value="{{@$flash_deal->flash_deal_banner_image_media->media_id}}">
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        <tbody id="sku_tbody">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="product_info">
                                                        <div class="product_img_div">
                                                            <img class="productImg" src="{{ showImage(@$product->productAll->product->thumbnail_image_source) }}" alt="">
                                                        </div>
                                                        <div class="product_name_div">
                                                            <p class="text-nowrap">{{substr(@$product->productAll->product->product_name, 0, 40)}}</p>
                                                            <input type="hidden" name="products[]" value="{{@$product->productAll->id}}">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="mt-25 ml-5 mr-5 text-nowrap">
                                                        @if (@$product->productAll->product->product_type == 1)
                                                        {{single_price(@$product->productAll->skus->max('selling_price'))}}
                                                        @else
                                                        {{single_price(@$product->productAll->skus->min('selling_price'))}} - {{single_price(@$product->productAll->skus->max('selling_price'))}}
                                                        @endif
                                                    </p>
                                                    <input type="hidden" name="price[]" value="{{single_price(@$product->productAll->skus->max('selling_price'))}}">
                                                </td>
                                                ...
                                                <td class="text-center pt-25">
                                                    ...
                                                    <input type="hidden" id="product_{{$product->productAll->id}}">
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>

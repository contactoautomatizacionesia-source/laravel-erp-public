...
class ReferralCodeService{
    ...
    public function validateExistenceByReferralCode(string $referralCode): bool {
        return $this->referralCodeRepository->validateExistenceByReferralCode($referralCode);
    }

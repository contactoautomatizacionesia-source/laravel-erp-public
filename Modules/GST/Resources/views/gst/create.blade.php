<div class="box_header common_table_header">
    <div class="main-title d-md-flex">
        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('gst.add_new_gst') }}</h3>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="primary_input mb-15">
                    ...
                    <input class="primary_input_field" name="rate" id="rate" placeholder="{{__("gst.rate")}}" type="number" min="0" step="{{step_decimal()}}" max="100" value="{{old('rate')}}">
           ...
           @if (permissionCheck('gst_tax.store'))

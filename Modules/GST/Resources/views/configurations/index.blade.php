                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="permission_list sms_list">
                                    ...
                                    <li>
                                        <label class="primary_checkbox d-flex mr-12 ">
                                            <input name="enable_gst" type="radio" id="enable_gst_3" value="only_tax" @if (app('gst_config')['enable_gst'] == "only_tax") checked @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                        <p>{{ __('gst.is_active_only_tax') }}</p>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-12 inside_state_div @if (app('gst_config')['enable_gst'] == "flat_tax" || app('gst_config')['enable_gst'] == "only_tax") d-none @endif">
                            ...
                            <div class="col-lg-12 outside_state_div @if (app('gst_config')['enable_gst'] == "flat_tax" || app('gst_config')['enable_gst'] == "only_tax") d-none @endif">
                                <div class="primary_input mb-15">
                            ...
                            <div class="col-lg-12 flat_div @if (app('gst_config')['enable_gst'] == "gst" || app('gst_config')['enable_gst'] == "only_tax") d-none @endif">
                                <div class="primary_input mb-15">
                ...
                <section class="admin-visitor-area up_st_admin_visitor">
                    ...
                    <div class="container-fluid p-0">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-8 list_div white_box_30px">
                                <div class="box_header common_table_header">
                                    <div class="main-title d-md-flex">
            ...
            $(document).ready(function(){
                ...
                $(document).on('change', '#outsite_state_gst', function(event){
                    ...
                    if(list.length){
                        ...
                        toastr.info('Debe seleccionar al menos uno.');
                    }
                });
                ...
                function showValidationErrors(errors) {
                    ...
                    $('#error_same_state_gst').text(errors['same_state_gst_percent.0']);
                    $('#error_outsite_state_gst').text(errors['outsite_state_gst_percent.0']);
                }

                function resetValidationErrors(){
                    $('#error_name').text('');
                    $('#error_same_state_gst').text('');
                    $('#error_outsite_state_gst').text('');
                    $('#error_slug').text('');

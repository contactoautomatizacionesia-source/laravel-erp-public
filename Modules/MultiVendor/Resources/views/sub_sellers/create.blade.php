        ...
        <div class="row justify-content-center mb-40">
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex justify-content-between w-100">
                        <h3 class="mb-0 mr-30">{{__('seller.create_a_staff')}}</h3>
            ...
            <div class="col-12">
                <div class="white_box_30px box_shadow_white">
                    <form action="{{ route('seller.sub_seller.store') }}" method="POST" id="staff_addForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xl-12">
                            ...
                            <div class="col-md-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" class="primary_input_field" placeholder="{{ __('common.first_name') }}" name="first_name" value="{{old('first_name')}}">
                            ...
                            <div class="col-md-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" class="primary_input_field" placeholder="{{ __('common.last_name') }}" name="last_name" value="{{old('last_name')}}">
                            ...
                            <div class="col-md-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" id="phone" class="primary_input_field" name="phone" placeholder="{{__('common.phone')}} " value="{{old('phone')}}">
                            ...
                            <div class="col-md-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" id="address" class="primary_input_field" name="address" placeholder="{{__('common.address')}}" value="{{old('address')}}">
                                    <span class="text-danger">{{$errors->first('address')}}</span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="address">{{__('common.avatar')}} ({{getNumberTranslate(165)}}x{{getNumberTranslate(165)}}) {{__('common.px')}} <span class="text-danger"></span></label>

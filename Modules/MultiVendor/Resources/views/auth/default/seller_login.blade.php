        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-6 col-xl-4">
                ...
                <div class="register_form_iner">
                    ...
                    <form method="POST" class="register_form" name="login" action="{{ route('seller.login_submit') }}" id="login_form">
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 text-center">
                                <div class="register_area">
                                    ...
                                    <p> <a href="{{url('/merchant-register-step-1')}}">{{ __('defaultTheme.create_account') }}</a> {{ __('common.here') }}</p>
                                </div>
                            </div>
                        </div>
                    </form>

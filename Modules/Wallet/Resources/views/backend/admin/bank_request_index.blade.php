...
@section('mainContent')
    <section class="admin-visitor-area up_st_admin_visitor ign-bank-recharge-requests">
        <div class="container-fluid white_box_30px">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('wallet.bank_recharge_transactions') }}</h3>
                        </div>
                    </div>
        ...
        $(document).ready(function(){
            ...
            function walletTable(){
                $('#walletTable').DataTable({
                    ...
                    stateSave: true,
                    "ajax": ( {
                        url: "{{ route('bank_recharge.get-data') }}"
                    }),

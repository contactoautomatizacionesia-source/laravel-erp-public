...
class Brand extends Model
{
    ...
    public $translatable = ['name', 'description', 'meta_title', 'meta_description', 'full_name'];
    protected $casts = [
        'id' => 'integer',
        'name' => 'string',
        'full_name' => 'string',
    ...
    public function brand_image_media()
    {
        return $this->morphOne(UsedMedia::class, 'usable')->where('used_for', 'brand_image');
    }
    ...
    public function dianSetting()
    {
       return $this->hasOne(DianSetting::class, 'brand_id', 'id');
    }
}

...
class BrandTest extends TestCase
{
    ...
    public function test_for_create_brand()
    {
        ...
        $this->post('/products/brands-store',[
            ...
            'featured' => 1
        ])->assertRedirect('/products/brands-list');
    ...
    public function test_for_update_brand()
    {
        ...
        $this->post('/products/brands-update/'.$brand->id,[
    ...
    public function test_for_delete_brand()
    {
        ...
        $this->get('/products/brands-destroy/'.$brand->id)->assertRedirect('/products/brands-list');
    ...
    public function test_for_status_change_brand()
    {
        ...
        $this->post('/products/brands-update-status',[
            'id' => $brand->id,
            'status' => 1
        ])->assertSee(1);
    ...
    public function test_for_featured_change_brand()
    {
        ...
        $this->post('/products/brands-update-feature',[
            'id' => $brand->id,
            'status' => 1
        ])->assertSee(1);
    ...
    public function test_for_load_more_brand()
    {
        ...
        $this->post('/products/load-more-brand',[
            'skip' => 10
        ])->assertSee('brands');

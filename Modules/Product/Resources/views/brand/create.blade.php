                            ...
                            <div class="row">
                                ...
                                @else
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{__("common.full_name")}} <span class="text-danger">*</span></label>
                                            <input class="primary_input_field" name="full_name" placeholder="{{__("common.full_name")}}" type="text" value="{{old('full_name')}}">
                                            @error('full_name')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{__("common.nit")}} <span class="text-danger">*</span></label>
                                            <input class="primary_input_field" name="nit" placeholder="{{__("common.nit")}}" type="text" value="{{old('nit')}}">
                                            @error('nit')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade pelement @if (auth()->user()->lang_code == $language->code) show active @endif" id="pelement{{$language->code}}">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <textarea class="primary_textarea height_112 meta_description" placeholder="{{ __('common.meta_description') }}" name="meta_description[{{$language->code}}]" spellcheck="false">{{old('meta_description.'.$language->code)}}</textarea>
                    ...
                    <div class="col-lg-4">
                        <div class="form-card">
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="d-flex">
                                        <h3 class="mb-2 mr-30">{{ __('common.logo') }} ({{getNumberTranslate(150)}} X {{getNumberTranslate(150)}}){{__('common.px')}}</h3>
                                    </div>
                                </div>
                                <div class="col-lg-12">

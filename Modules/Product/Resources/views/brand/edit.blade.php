                            ...
                            @else
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <input class="primary_input_field" name="full_name" placeholder="{{__("common.full_name")}}" type="text" value="{{$brand->full_name}}">
                                        @error('full_name')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <input class="primary_input_field" name="nit" placeholder="{{__("common.nit")}}" type="text" value="{{$brand->nit}}">
                                        @error('nit')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>

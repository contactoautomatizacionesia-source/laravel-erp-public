                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for="">
                                                    {{__("product.min_stock")}}
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <input class="primary_input_field" name="min_stock" id="min_stock" value="{{ $product->min_stock }}" type="number" min="1" step="0" required="1">
                                                <span class="text-danger" id="error_min_stock">{{$errors->first('min_stock')}}</span>
                                            </div>
                                        </div>
                                        <!-- Maximum Stock -->
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for="">
                                                    {{__("product.max_stock")}}
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <input class="primary_input_field" name="max_stock" type="number" min="1" step="0" value="{{ $product->max_stock }}" required="1">
                                        ...
                                        @if(isModuleActive('GoogleMerchantCenter'))
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="gtin" id="gtin" placeholder="{{ __('common.gtin') }}" type="text" value="{{ $product->gtin }}">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="mpn" id="mpn" placeholder="{{ __('common.mpn') }}" type="text" value="{{ $product->mpn }}">
                                        ...
                                        @if(isModuleActive('ClubPoint'))
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="club_point" id="club_point" placeholder="{{ __('clubpoint.point') }}" type="number" min="0" value="{{ @$product->club_point }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 weight_height_div">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> {{ __('product.weight')}} [{{__('product.gm')}}]</label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> {{ __('product.length')}} [{{__('product.cm')}}]</label>
                                        ...
                                        <div class="col-lg-6 selling_price_div">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field selling_price" name="selling_price" id="selling_price" placeholder="{{__("product.selling_price")}}" type="number" min="1" step="{{step_decimal()}}" value="{{ @$product->skus->first()->selling_price }}" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">{{ __('gst.GST_group')}}</label>
                                ...
                                <div class="white_box pt-0 box_shadow_white p-15">
                                            ...
                                            <div class="primary_input mb-25">
                                                <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="true" data-type="image" data-name="images[]">
                                                    <input class="primary-input file_amount" type="text" id="thumbnail_image_file"
                                                        placeholder="{{ __('common.choose_images') }}" readonly="">
                                                    <button class="" type="button">
                                    ...
                                    <div class="row">
                                        ...
                                        @if(isModuleActive('GoldPrice'))
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label">{{__('product.auto_update_required') }} <span class="text-danger">*</span></label>
                                                    <ul id="theme_nav" class="permission_list sms_list ">
                                                        <li>
                                                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    <label class="primary_input_label" for="making_charge"> {{__('product.making_charge') }}
                                                    </label>
                                        ...
                                        <tbody id="tablecontentsupSaleAll">
                                            ...
                                            @foreach ($upSales as $key => $upSale)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="product_img_div">
                                                            <img class="product_list_img" src="{{ showImage($upSale->main_product->thumbnail_image_source) }}" alt="{{ $upSale->main_product->product_name }}">
                                                        </div>
                                                    </td>

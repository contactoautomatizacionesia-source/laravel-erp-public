...
<x-admin.section >
    <div class="role_permission_wrap">
        <div class="permission_title d-flex flex-wrap justify-content-between mb_20">
            ...
            <a href="#" id="resetMenu" class="primary-btn radius_30px mr-10 fix-gr-bg">{{__('general_settings.reset_to_default')}}</a>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                ...
                                aria-controls="collapseOne">
                                    <button class="btn btn-link add_btn_link"> {{__('common.add_section')}}</button>
                                </h5>
                            </div>
                                        ...
                                        <div id="row_element_div" class="row">
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <input class="primary_input_field name" type="text" id="section_name" name="name" autocomplete="off" placeholder="{{__('common.name')}}">
                                                </div>
                                                <span class="text-danger" id="error_section_name"></span>
                                            </div>
                                            <div class="col-lg-12 text-center">
                                                <button id="add_row_btn" type="submit" class="primary-btn fix-gr-bg submit_btn" data-toggle="tooltip" title="" data-original-title=""><span class="ti-check"></span>{{__('common.save')}} </button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

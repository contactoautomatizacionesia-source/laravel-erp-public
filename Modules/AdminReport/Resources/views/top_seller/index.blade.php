                            ...
                            <div class="">
                                <table id="visitorTable" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('common.seller') }} {{ __('common.id') }}</th>
                                        <th scope="col">{{ __('common.shop_name') }}</th>
                                        <th scope="col">{{ __('common.email') }}</th>
                                        <th scope="col">{{ __('common.phone') }}</th>
                                        <th scope="col">{{ __('common.total_sale') }}</th>
                                        <th scope="col">{{ __('common.joined_at') }}</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
    ...
    <script type="text/javascript">
        (function($){
            ...
            $('#visitorTable').DataTable({
                    ...
                    stateSave: true,
                    "ajax": ( {
                        url: "{{ route('report.top_seller_data') }}"
                    }),
                    ...
                    columns: [
                                ...
                                { data: 'total_sale_qty', name: 'total_sale_qty' },

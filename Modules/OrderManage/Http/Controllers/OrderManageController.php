...
class OrderManageController extends Controller
{
        ...
        if (isset($_GET['table'])) {
            ...
            return DataTables::of($order_package)
                ...
                ->addColumn('cost_center', function($order){
                    return $this->resolveCostCenterLabel($order->order);
    ...
    public function total_sales_get_data()
    {
        ...
        if (isset($_GET['table'])) {
            ...
            return DataTables::of($order)
                ...
                ->addColumn('payment_reference', function($order){
                    return '-';
    ...
    public function sales_info_update(Request $request, $id)
    {
        ...
        unset($data['_token']);
        $redirectRoute = route('order_manage.show_details', $id);
    ...
    public function update_delivery(Request $request, $id)
    {
        ...
        try {
            ...
            LogActivity::errorLog($e->getMessage());
            Toastr::error(__('order.fefo_generic_error'), __('common.error'));
            DB::rollBack();
            return back();
        }
    }
    ...
    private function resolveCostCenterLabel($order): string
    {

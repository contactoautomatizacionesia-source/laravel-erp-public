        ...
        <div class="container-fluid p-0">
            <div class="row justify-content-center">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="box_header common_table_header justify-content-between">
                        <div class="main-title d-md-flex align-items-center">
                            <x-backEnd.back-button :text="false" />
                            <h3 class="mb-0 mr-30 ml-3 mb_xs_15px mb_sm_20px">{{getNumberTranslate($order->order_number)}}</h3>
                ...
                <div class="col-lg-8 student-details">
                    <div class="white_box_30px box_shadow_white" id="printableArea">
                        ...
                        <div class="row mt-30">
                            <div class="col-md-6 col-lg-6">
                                <h4 class="table-heading">{{__('defaultTheme.billing_info')}}</h4>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <h4 class="table-heading">{{__('defaultTheme.seller_info')}}</h4>
                                <table class="invoice-table table-borderless clone_line_table">
                        ...
                        <div class="row mt-30">
                            <div class="col-md-6 col-lg-6">
                                <h4 class="table-heading">{{__('defaultTheme.shipping_info')}}</h4>
                                <table class="invoice-table table-borderless clone_line_table">
                            ...
                            @endif
                            <div class="col-md-6 col-lg-6">
                                <h4 class="table-heading">{{__('defaultTheme.payment_info')}}</h4>
                                <table class="invoice-table table-borderless clone_line_table">
                                ...
                                @if(isModuleActive('Affiliate'))
                                    @if($order->affiliateUser)
                                        <h4 class="table-heading">{{__('affiliate.affiliate_user')}}</h4>
                                        <table class="invoice-table table-borderless clone_line_table">
                        ...
                        <div class="row mt-30">
                            <div class="col-12">
                                <div class="">
                                    <h4 class="mb-0 mr-30">{{__('common.cost_center')}}:
                                        Armenia
                                    </h4>
                                    <p class="text-black">
                                                ...
                                                <tbody>
                                                    @foreach ($order_packages->products as $key => $package_product)
                                                        <tr>
                                                                ...
                                                                <div class="product_img_div">
                                                                    ...
                                                                    @else
                                                                        @php
                                                                            ...
                                                                            $thumbnail = @$spsku->sku->product->thumbnail_image_source;
                                                                        @endphp
                                                                        @if (@$spsku->sku->product->product_type == 1)
                                                                            <img src="{{showImage(@$spsku->product->thum_img ?: $thumbnail)}}" alt="#">
                                                                        @else
                                                                            <img src="{{showImage(@$spsku->sku->variant_image ?: @$spsku->product->thum_img ?: $thumbnail)}}" alt="#">
                                                                        @endif
                                                                    @endif
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="text-nowrap">{{ $package_product->unit_club_point > 0 ? getNumberTranslate($package_product->unit_club_point) : '-' }}</td>
                        ...
                        <div class="row mt-30">
                            ...
                            <div class="col-md-6">
                                <div class="border rounded-lg shadow-sm p-3">
                                    <h4 class="table-heading">{{__('common.order_summary')}}</h4>
                                    <table class=" totals-table table-borderless clone_line_table ml-md-auto mt-md-0 mt-2">
                ...
                <div class="col-lg-4 student-details">
                    ...
                    @if($order->is_confirmed && $order_packages->carrier->name == 'Torod' && $order_packages->torod_processing != 1)
                        <div class="row white_box p-25 ml-0 mr-0 box_shadow_white mt-20">
                    ...
                    <div class="row white_box p-25 ml-0 mr-0 box_shadow_white mt-20">
                        <div class="description_box">
                            <h3 class="f_s_14 f_w_500 mb_10">{{__('common.advised_by')}}</h3>

        ...
        <div class="invoice_print mb_30">
            <div class="container">
                <div class="invoice_part_iner">
                    <table class="table border_bottom mb_20">
                        <thead>
                            <tr>
                                <th>
                                    <div class="logo_div">
                                ...
                                <th class="virtical_middle text_right invoice_info">
                                    <h5 class="text_uppercase">{{app('general_setting')->company_name}}</h5>
                                    <h5>{{app('general_setting')->phone}}</h5>
                                    <h5>{{app('general_setting')->email}}</h5>
                                            ...
                                            <tr>
                                                 <td>
                                                     <p class="line_grid_2" >
                                                         ...
                                                         {{ app('general_setting')->system_domain }}
                                                     </p>
                                                 </td>
                                            </tr>
                                            <tr>
                                                 <td>
                                                     <p class="line_grid_2" >
                                                         <span>
                                                             <span>{{__('common.order')}} {{ __('common.date') }}</span>
                                                             
                                                         </span>
                                                        {{ date(app('general_setting')->dateFormat->format, strtotime(@$order->created_at)) }}
                                                     </p>
                                                 </td>
                                            </tr>
                                        </tbody>

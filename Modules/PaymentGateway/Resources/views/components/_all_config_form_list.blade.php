        ...
        <div class=" float-none pos_tab_btn justify-content-start">
            ...
            <ul class="nav nav_list" role="tablist">
                @foreach(@$gateway_activations as $gateway)
                    ...
                    @elseif($gateway->method->method == 'EPAYCO' && @$gateway->status == 1)
                    <li class="nav-item mb-2">
                        <a class="nav-link @if($key == 0) active show @endif" href="#epaycoTab" role="tab" data-toggle="tab" id="1"
                            aria-selected="true">{{__('payment_gatways.epayco')}}</a>
                    </li>
                    ...
                    @elseif(isModuleActive('Tabby') && $gateway->method->method == 'Tabby' && @$gateway->status == 1)
                        <li class="nav-item mb-2">
                            <a class="nav-link @if($key == 0) active show @endif" href="#Tabby" role="tab" data-toggle="tab" id="1"
                            aria-selected="true">{{__('payment_gatways.tabby')}}</a>
                        </li>
                    @elseif(isModuleActive('CCAvenue') && $gateway->method->method == 'CCAvenue' && @$gateway->status == 1)
                        <li class="nav-item mb-2">
                            <a class="nav-link @if($key == 0) active show @endif" href="#CCAvenue" role="tab" data-toggle="tab" id="1"
                            aria-selected="true">{{__('payment_gatways.ccavenue')}}</a>
                        </li>
                    @elseif( $gateway->method->method == 'Clickpay' && @$gateway->status == 1)

                        <li class="nav-item mb-2">
                            <a class="nav-link @if($key == 0) active show @endif" href="#clickpay" role="tab" data-toggle="tab" id="1"
                            aria-selected="true">{{__('payment_gatways.clickpay')}}</a>
                        </li>
                    @endif
                    @php
                        $key ++;
        ...
        <div class="tab-content">
            ...
            @foreach(@$gateway_activations as $gateway)
                ...
                @elseif($gateway->method->method == 'EPAYCO' && @$gateway->status == 1)
                    ...
                    <div role="tabpanel" class="tab-pane fade @if($key == 0) active show @endif" id="epaycoTab">
                        <div class="box_header common_table_header ">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('payment_gatways.epayco_configuration')}}</h3>
                                <ul class="d-flex">
                                    <div class="img_logo_div">
                                        <img src="{{ showImage(@$gateway->method->logo) }}" alt="">
                                    </div>
                        ...
                        @include('paymentgateway::components.epayco_config')
                    </div>
                ...
                @elseif(isModuleActive('Tabby') &&  $gateway->method->method == 'Tabby' && @$gateway->status == 1)
                    <div role="tabpanel" class="tab-pane fade @if($key == 0) active show @endif" id="Tabby">
                        <div class="box_header common_table_header ">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('payment_gatways.tabby_configuration')}}</h3>
                                <ul class="d-flex">
                                    <div class="img_logo_div">
                                        <img src="{{ showImage(@$gateway->method->logo) }}" alt="">
                                    </div>
                        ...
                        @include('tabby::config')
                    </div>
                @elseif(isModuleActive('CCAvenue') &&  $gateway->method->method == 'CCAvenue' && @$gateway->status == 1)
                    <div role="tabpanel" class="tab-pane fade @if($key == 0) active show @endif" id="CCAvenue">
                        <div class="box_header common_table_header ">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('payment_gatways.ccavenue_configuration')}}</h3>
                                <ul class="d-flex">
                                    <div class="img_logo_div">
                                        <img src="{{ showImage(@$gateway->method->logo) }}" alt="">
                                    </div>
                        ...
                        @include('ccavenue::config')
                    </div>
                @elseif(isModuleActive('Clickpay') &&  $gateway->method->method == 'Clickpay' && @$gateway->status == 1)
                    <div role="tabpanel" class="tab-pane fade @if($key == 0) active show @endif" id="clickpay">
                        <div class="box_header common_table_header ">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('payment_gatways.clickpay_configuration')}}</h3>
                                <ul class="d-flex">
                                    <div class="img_logo_div">
                                        <img src="{{ showImage(@$gateway->method->logo) }}" alt="">
                                    </div>

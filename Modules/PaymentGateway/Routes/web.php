...
// Epayco Routes
Route::get('/epayco/checkout', 'EpaycoController@checkout')->name('epayco.checkout');
Route::get('/epayco/success', 'EpaycoController@success')->name('epayco.success');
Route::get('/epayco/failed', 'EpaycoController@failed')->name('epayco.failed');
Route::match(['get', 'post'], '/epayco/callback', 'EpaycoController@callback')->name('epayco.callback');

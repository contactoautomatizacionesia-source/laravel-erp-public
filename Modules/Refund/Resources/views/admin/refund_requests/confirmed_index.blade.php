...
@section('mainContent')
<section class="admin-visitor-area up_st_admin_visitor ign-all-confirmed-refund-request ">
    <div class="container-fluid white_box_30px">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="box_header common_table_header">
                    <div class="main-title d-md-flex">
                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('refund.confirmed_refund_requests') }}</h3>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        (function($){
            ...
            $('#refundTable').DataTable({
                    ...
                    serverSide: true,
                    "ajax": ( {
                        url: "{{ route('refund.all_refund_request_data') }}"+'?table=confirmed'
                    }),

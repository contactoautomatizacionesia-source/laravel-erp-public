                                ...
                                <div class="col-md-6 col-lg-6">
                                    <table class="table-borderless clone_line_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>: {{ getNumberTranslate(@$common_request->pick_up_address_customer->phone) }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>: {{ getNumberTranslate(@$refund_request->pick_up_address_customer->postal_code) }}</td>
                                        </tr>
                                    </table>
                                </div>
                            @else
                                ...
                                <div class="col-12 mt-30">
                                    <div class="box_header common_table_header">
                                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('common.package') }}:
                                            {{ getNumberTranslate(@$refund_detail->order_package->package_code) }} <small>({{ @$refund_detail->process_refund->name }})</small></h3>
                                        <ul class="d-flex float-right">
                                            @if(isModuleActive('MultiVendor'))
                                            <li> <strong>@if(@$refund_detail->order_package->seller->role->type == 'seller'){{ (@$refund_detail->order_package->seller->SellerAccount->seller_shop_display_name) ? @$refund_detail->order_package->seller->SellerAccount->seller_shop_display_name : @$order_package->seller->first_name }} @else {{__('refund.inhouse')}} @endif</strong> </li>
                                            @endif
                                        </ul>
                                    </div>

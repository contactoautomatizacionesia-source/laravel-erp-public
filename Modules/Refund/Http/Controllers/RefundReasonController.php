...
use Modules\Refund\Http\Requests\RefundReasonRequest;
...
class RefundReasonController extends Controller
{
    ...
    public function store(RefundReasonRequest $request)
    {
        try {
            ...
            return response()->json(["message" => "Nueva razón agregada exitosamente"], 200);
        } catch (\Exception $e) {
    ...
    public function update(RefundReasonRequest $request, $id)
    {
        try {
            ...
            return response()->json(["message" => "Razón de reembolso actualizada exitosamente"], 200);
        } catch (\Exception $e) {
            LogActivity::errorLog($e->getMessage());
            return response()->json(["message" => "Algo salió mal", "error" => $e->getMessage()], 503);
        }

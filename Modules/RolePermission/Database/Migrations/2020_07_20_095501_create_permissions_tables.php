...
class CreatePermissionsTables extends Migration
{
    ...
    $sql = [
        ...
        ['id'  => 79, 'module_id' => 4, 'parent_id' => 68, 'name' => 'Slider', 'route' => 'appearance.slider.index', 'type' => 2 ],
        ['id'  => 80, 'module_id' => 4, 'parent_id' => 79, 'name' => 'Status Change', 'route' => 'appearance.slider.update_status', 'type' => 3 ],
        ['id'  => 81, 'module_id' => 4, 'parent_id' => 79, 'name' => 'Setup', 'route' => 'appearance.slider.setup', 'type' => 3 ],
        ...
        ['id'  => 561, 'module_id' => 4, 'parent_id' => 68, 'name' => 'Color Scheme', 'route' => 'appearance.themeColor.index', 'type' => 2 ],
        ['id'  => 562, 'module_id' => 4, 'parent_id' => 561, 'name' => 'Update', 'route' => 'appearance.themeColor.update', 'type' => 3 ],
        ['id'  => 563, 'module_id' => 4, 'parent_id' => 561, 'name' => 'Activate', 'route' => 'appearance.themeColor.activate', 'type' => 3 ],
        ...
        ['id' => 87, 'module_id' => 6, 'parent_id' => 86, 'name' => 'Blog Posts', 'route' => 'blog.posts.index', 'type' => 2 ],
        ...
        ['id' => 90, 'module_id' => 6, 'parent_id' => 87, 'name' => 'Destroy', 'route' => 'blog.posts.destroy', 'type' => 3 ],
        ...
        ['id' => 291, 'module_id' => 16, 'parent_id' => 290, 'name' => 'Order Manage', 'route' => 'order_manage.total_sales_index', 'type' => 2 ],
        ...
        ['id'  => 457, 'module_id' => 30, 'parent_id' => 453, 'name' => 'Delete', 'route' => 'holidays.destroy', 'type' => 3 ],

   ...
   <body>
      @php
        ...
        if(!empty($generalSetting)){
            ...
            try {
                  ...
                  $translatedMonth = \Carbon\Carbon::createFromFormat('F', $m)->translatedFormat('F');
            } catch (\Exception $e) {
                  $translatedMonth = $m;
            }
      @endphp
      <div class="container-fluid">
         <table  cellspacing="0" width="100%">
            <tr>
               <td>
                  <img class="logo-img" src="{{ showImage($generalSetting->logo) }}" alt="">
               </td>
               <td>
                  <h3 style="font-size:22px !important" class="text-white"> {{isset($site_title)?$site_title:'AmazCart'}} </h3>
                  <p style="font-size:18px !important" class="text-white mb-0"> {{isset($address)?$address:'Dhaka
                  '}} </p>
               </td>
               <td style="text-aligh:center">
                  ...
                  <p style="font-size:14px !important; border-bottom:1px solid gray" align="left" class="text-white">@lang('common.month'): {{ $translatedMonth }} </p>

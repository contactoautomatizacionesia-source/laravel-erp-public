                    ...
                    <div class="white_box_30px box_shadow_white">
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                            ...
                                            <div class="col">
                                                <div class="">
                                                    <input placeholder="{{ __('common.date') }}"
                                                           ...
                                                           value="{{getNumberTranslate(date('m/d/Y'))}}" autocomplete="off" />
                                                </div>
                                            </div>
                                ...
                                <button type="submit" class="primary-btn btn-sm fix-gr-bg pull-right search-btn d-none" ><i class="ti-search"></i>{{__('common.search') }}</button>
                            </div>
                        </div>
                    </div>
                </div>

                                                                ...
                                                                @foreach($giftCards->addGiftCard as $key=>$data)
                                                                    <div class="tab-pane fade {{$key == 0 ? 'show active' : ''}}" id="secton-{{$key+1}}" role="tabpanel" tabindex="0">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="primary_input mb-25">
                                                                                    <label class="primary_input_label" for="in_app_purchase_code">
                                                                                        {{__('product.in_app_purchase_code')}}: <span class="text-danger">*</span></label>
                                                                                    <input class="primary_input_field"  id="in_app_purchase_code[{{$key}}]" name="section[{{$key}}][in_app_purchase_code]" autocomplete="off" value="{{$data->in_app_purchase}}">
                                                                                </div>
                                                                            </div>

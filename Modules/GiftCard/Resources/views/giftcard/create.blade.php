                            ...
                            <div class="row">
                                <div class="col-lg-8" id="lg-toggle-8">
                                    ...
                                    <div class="row {{ $redeem_card == false ? 'd-none':'' }} " id="redeem_card_row">
                                        ...
                                        <div class="col-lg-6 {{ $redeem_card == false ? 'd-none':'' }}" id="redeem_purchase_code">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for="">
                                                    {{ __('product.in_app_purchase_code') }} </label>
                                                <input class="primary_input_field" name="reedem_in_app_purchase_code"
                                                id="in_app_purchase_code"
                                                    placeholder="{{ __('product.in_app_purchase_code') }}" type="text"
                                                    >

                                                <span class="text-danger">{{ $errors->first('in_app_purchase_code') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-25">
                                ...
                                <div class="col-lg-12 " id="note_editor" style="display:{{ $redeem_card == false ? 'none':'' }}">
                                    <div class="primary_input mb-25">
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '#gift_card_prod', function(e) {
                    ...
                    $("#redeem_purchase_code").addClass('d-none');
                ...
                $(document).on('click', '#redeem_card', function(e) {
                    ...
                    $("#redeem_purchase_code").removeClass('d-none');
                                ...
                                <div class="tab-pane fade" id="secton-${sections}" role="tabpanel" tabindex="0">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                    for="in_app_purchase_code">
                                                    {{__('product.in_app_purchase_code')}}: <span
                                                        class="text-danger">*</span></label>
                                                <input class="primary_input_field" type="text"
                                                    id="in_app_purchase_code${sections}"
                                                    name="section[${sections}][in_app_purchase_code]"
                                                    autocomplete="off" >
                                            </div>
                                        </div>
                                        <div class="col-lg-6">

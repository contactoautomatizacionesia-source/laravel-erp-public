...
class TagController extends Controller
{
    ...
    public function get_data(){
        ...
        return DataTables::of($value)
            ...
            ->addColumn('name', function($value){
                return getNumberTranslate(Str::limit($value->name,15));
            })
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json(["message" => "Etiqueta agregada exitosamente"], 200);
        } catch (\Exception $e) {
            LogActivity::errorLog($e->getMessage());
    ...
    public function getByAjax(Request $request){
        $tags = $this->tagService->getByAjax($request->search);

                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="main-title">
                                    <h3 class="mb-30">{{ __('setup.google_recaptcha') }} </h3>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                    <div class="white_box_30px box_shadow_white mb-40 minh-430">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <span class="text-danger"><code>{{__('setup.nb: using_google_reCaptcha_v3_and_Google_reCaptcha_v2(invisible &amp; checkbox)|')}} <a target="_blank" href="https://www.google.com/recaptcha/admin">{{__('setup.click_here_to_get_keys')}}</a></code></span>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <span class="text-danger" id="error_google_captcha_sitekey"></span>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-25">
                                                ...
                                                <span class="text-danger" id="error_google_captcha_secret"></span>
                                            </div>
        ...
        (function($){
            ...
            $(document).ready(function(){
                ...
                $(document).on('click', '#google_submit_btn', function(event){
                    ...
                    $('#error_google_captcha_sitekey').text("");
                   $('#error_google_captcha_secret').text("");
                    $.ajax({
                        ...
                        error: function(response) {
                            if(response.responseJSON.errors){
                                $('#error_google_captcha_sitekey').text(response.responseJSON.errors.captcha_sitekey);
                                $('#error_google_captcha_secret').text(response.responseJSON.errors.captcha_secret);
                                toastr.error(response.responseJSON.errors ,"{{__('common.error_message')}}");
                                $('#pre-loader').addClass('d-none');
                                return false;
                            }
                        }

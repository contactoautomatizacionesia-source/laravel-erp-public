            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="box_header common_table_header">
                        ...
                        <h3 class="mb-3 mb-xl-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('hr.department') }} {{ __('common.list')  }}</h3>
                        @if(permissionCheck('departments.store'))
                            <ul class="d-flex">
                                <li><button class="primary-btn radius_30px mr-10 fix-gr-bg" id="add_new_btn"><i class="ti-plus"></i>{{ __('common.add_new') }}</button></li>
                            </ul>
                            @endif
                        </div>
                    </div>

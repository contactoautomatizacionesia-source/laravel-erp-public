                ...
                <div class="col-lg-9 white_box_30px mb_30">
                        ...
                        <div class="box_header_right">
                            <div class="pos_tab_btn justify-content-end">
                                <ul class="nav ign-scrollbar flex-nowrap w-100 overflow-auto pb-2">
                                    <li class="nav-item">
                                        <a class="nav-link active show" href="#all_states" role="tab" data-toggle="tab" aria-selected="true" data-table="all">
                                            {{ __('common.all') }}
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#active_states" role="tab" data-toggle="tab" aria-selected="false" data-table="active">
                                            {{ __('common.active') }}
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#inactive_states" role="tab" data-toggle="tab" aria-selected="false" data-table="inactive">
                                            {{ __('common.inactive') }}
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#default_states" role="tab"
                    ...
                    <div class="col-12">
                        <div class="box_header common_table_header">
                            ...
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px" id="table_title">{{ __('common.state') }} {{ __('common.list')  }}</h3>
...
@include('backEnd.partials.delete_modal',['item_name' => __('common.state')])

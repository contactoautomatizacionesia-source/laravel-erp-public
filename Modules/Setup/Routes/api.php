...
Route::middleware('auth:sanctum')->prefix('setup')->group(function () {
    Route::get('/algolia-search-config','API\SetupController@algoliaSearchConfig');
    Route::post('/update-algolia-search-config', 'API\SetupController@updateAlgoliaSearchConfig');
});

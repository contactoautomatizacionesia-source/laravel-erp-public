...
Route::get('/location/country/search','CountryController@search')->name('setup.country.search');
Route::get('/location/state/search', 'StateController@search')->name('setup.state.search');
Route::get('/location/city/search', 'CityController@search')->name('setup.city.search');
Route::get('/location/city/search-for-select', 'CityController@searchForSelect')->name('setup.city.searchForSelect');
...
Route::middleware(['auth','admin'])->prefix('setup')->group(function() {
    ...
    Route::get('/location/country/get-data', 'CountryController@getData')->name('setup.country.getData');

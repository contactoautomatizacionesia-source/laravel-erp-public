...
use App\Console\Commands\VerifyEpaycoPayments;
use Modules\CycleClosure\Console\RunCycleClosureCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        VerifyEpaycoPayments::class,
        RunCycleClosureCommand::class,
    ];
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('epayco:verify-pending')->everyFiveMinutes();
        $schedule->command('cycle:close')->dailyAt('00:05')->runInBackground()->withoutOverlapping();

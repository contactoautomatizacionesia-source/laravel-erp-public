...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        'api_prohibited_demo_mode' => \App\Http\Middleware\ApiProhibitedInDemoMode::class,
        ...
        'cycle.period_blocked' => \Modules\CycleClosure\Http\Middleware\BlockedPeriodMiddleware::class,
        'kyc.updated' => \App\Http\Middleware\EnsureKycIsUpdated::class,
    ];
}

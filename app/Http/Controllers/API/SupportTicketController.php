...
use App\Http\Resources\Api\v1\SupportTicket\SupportTicketCategoryResource;
use App\Http\Resources\Api\v1\SupportTicket\SupportTicketPrioritiesResource;
...
class SupportTicketController extends Controller
{
    ...
    public function getTicketsWithPaginate(Request $request){
        ...
        return response()->json([
            'tickets' => $tickets,
            'statuses' => TicketStatusResource::collection($statuses),
            'msg' => trans('app.Success')
        ], 200);
    ...
    public function store(Request $request){
        ...
        return response()->json([
            'msg' => trans('app.created successfully')
        ],201);
    ...
    public function categoryList(){
        ...
        $categories = SupportTicketCategoryResource::collection($categoryRepo->getActiveAll());
        return response()->json([
    ...
    public function priorityList(){
        ...
        $priorities = SupportTicketPrioritiesResource::collection($priorityRepo->getActiveAll());
        return response()->json([
    ...
    public function replyTicket(Request $request){
        ...
        try{
            ...
            return response()->json([
                'msg' => trans('app.Reply done')
            ],201);

        }catch(Exception $e){
            return response()->json([
                'msg' => trans('app.Something went wrong')
            ],500);
        }
    }
}

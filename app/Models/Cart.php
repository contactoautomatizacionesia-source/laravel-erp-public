...
class Cart extends Model
{
    ...
    public function getUnitClubPointAttribute(): float
    {
        if ($this->product_type !== 'product') {
            return 0;
        }

        return (float) data_get($this, 'product.product.product.club_point', 0);
    }

    public function getTotalClubPointAttribute(): float
    {
        return $this->unit_club_point * (int) $this->qty;
    }
